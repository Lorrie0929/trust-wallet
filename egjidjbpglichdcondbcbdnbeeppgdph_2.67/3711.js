try {
  let e = "u" > typeof window ? window : "u" > typeof global ? global : "u" > typeof globalThis ? globalThis : "u" > typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e.t = e.t || {}, e.t[t] = "294792df-0a81-43d8-b3b2-444ec67ac97b", e.i = "sentry-dbid-294792df-0a81-43d8-b3b2-444ec67ac97b")
      ...
      class h extends(o()) {
        constructor(e = {}) {
          super(), this.id = {}, this.lifetimeId = {}, this.retryCnt = 0, this.stopped = !1, this.opts = ((e, t) => {
            for (var c in t || (t = {})) p.call(t, c) && l(e, c, t[c]);
            if (n)
              for (var c of n(t)) d.call(t, c) && l(e, c, t[c]);
            return e
          })({
            interval: 2e3,
            retry: 5
    ...
    37464: (e, t, c) => {
      ...
      function i(e) {
        ...
        const d = null == (c = e.method) ? void 0 : c.toUpperCase(),
          [l, h] = e.url.slice(a.W2.length).split("?"),
    ...
    73711: (e, t, c) => {
      ...
      const C = () => {
        ...
        const {
          ...
          value: D
        }), M = (0, w.n)(!0), _ = (0, P.I)(!0), R = (0, T.useMemo)(() => [...M, ..._], [M, _]), L = (0, i.U)({
          value: F,
          rpcUrl: D,
          blockchains: R
        }), U = (0, d.u)({
          ...
          value: S
        }), G = (0, T.useMemo)(() => L.isValid && $.isValid && q.isValid && U.isValid && (!S || V.isValid), [L.isValid, S, V.isValid, $.isValid, q.isValid, U.isValid]), W = (0, T.useRef)(!1), X = (0, T.useCallback)(e => ((e, t, c) => new Promise((e, t) => {
          var a = e => {
              try {
                s(c.next(e))
              } catch (e) {
      ...
      const G = {
        ...
        W = (e, t, c) => {
          ...
          return {
            suggestedMaxPriorityFeePerGas: (0, V.fromWei)(a, "gwei"),
            suggestedMaxFeePerGas: (0, V.fromWei)((0, _.z)(a).add(t).toString(), "gwei"),
      ...
      let ge = class {
        ...
        fetchKeystoreStorage(e) {
          return new le.KeyStore.ExtensionStorage(ge.walletIdsKey(e), this.getStorageProvider())
        }
        serialize(e) {
      ...
      let Ie = class {
        ...
        setStorageProvider(e) {
          this.keystore = new le.KeyStore.Default(this.walletCore, e)
        }
        import(e, t, c, a) {
        ...
        customDerivation(e, t, c, a) {
          return Ce(this, null, function*() {
            ...
            for (const e of c) {
              const t = null == (o = he.find(t => t.coinId === e.value)) ? void 0 : o.derivation[0].path,
                c = t?.lastIndexOf("0");
              if (!c) continue;
      ...
      Ee([pe(ge)], Ie.prototype, "storageService", 2), Ie = Ee([(0, te.k)()], Ie);
      var Be = c(11377),
        De = c(48287).Buffer,
      ...
      let He = class {
        ...
        generateMnemonicWallet(e) {
          return e || R.A.error("Trying to generate wallet without password"), this.walletCore.HDWallet.create(He.DEFAULT_STRENGTH, e)
        }
        isValidMnemonic(e) {
        ...
        decodeBitcoinTransaction(e) {
          return le.TW.Bitcoin.Proto.SigningInput.decode(e)
        }
        decodeBitcoinPlan(e) {
          return le.TW.Bitcoin.Proto.TransactionPlan.decode(e)
        }
        sign(e, t) {
      ...
      He.DEFAULT_STRENGTH = 128, ze([pe(Ie)], He.prototype, "keyStoreService", 2), ze([pe(J.r)], He.prototype, "walletKitService", 2), He = ze([(0, te.k)(), (0, ce.x)(8)], He);
      var Se = c(93378);
      ...
      var Re = (e => (e.INIT = "INIT", e.UNLOCK = "UNLOCK", e.LOCK = "LOCK", e))(Re || {}),
        Le = Object.defineProperty,
        Ue = Object.getOwnPropertySymbols,
        Ve = {}.hasOwnProperty,
        Ge = {}.propertyIsEnumerable,
        We = (e, t, c) => t in e ? Le(e, t, {
          enumerable: !0,
          configurable: !0,
          writable: !0,
          value: c
        ...
        Xe = (e, t) => {
          for (var c in t || (t = {})) Ve.call(t, c) && We(e, c, t[c]);
          if (Ue)
            for (var c of Ue(t)) Ge.call(t, c) && We(e, c, t[c]);
          return e
        };
      ...
      tt.DEFAULT_ITERATIONS = 2e4, tt.DEFAULT_BIT_KEY_LEN = 512, et([pe(He)], tt.prototype, "walletCoreService", 2), tt = et([(0, te.k)()], tt);
      ...
      let nt = class {
        constructor() {
          this.store = new _e(Je), this.store.subscribe(this.onUpdate.bind(this))
        }
        onUpdate() {
        ...
        create(e) {
          return it(this, null, function*() {
            (yield this.getPassword()) && R.A.warn("Vault already started");
      ...
      nt.STORAGE_KEY = "trust:vault", nt.MIGRATION_KEY = "trust:migrated", nt.PBKDF2_KEY = "trust:pbkdf2", nt.PASSWORD_KEY = "password", rt([pe(ge)], nt.prototype, "storageService", 2), rt([pe(He)], nt.prototype, "walletCoreService", 2), rt([pe(tt)], nt.prototype, "passwordService", 2), nt = rt([(0, te.k)()], nt);
      var pt = c(8935),
        dt = c(61855),
        lt = c(11711),
        ht = c(67168),
          ...
          return c.value = function(...c) {
            return ((e, t, c) => new Promise((t, a) => {
              ...
              try {
                ...
                R.A.error(`Error in ${null==(o=e?.constructor)?void 0:o.name}.${t}`), R.A.error(c)
              }
            })
          }, c
        }
      ...
      let Ot = class {
        transformTransaction(e, t) {
          return jt(this, null, function*() {
            R.A.debug("Sending transform request");
            const c = e === gt.p.SIMULATION ? "simulate" : "visualize",
              a = yield L.A.post(`${ft.JR}/v1/wizard/${c}`, t);
            if (R.A.debug("Data transform request done"), a.data.Result.ResultError) throw "1" === a.data.Result.ResultError.error_code ? new At : Error(a.data.Result.ResultError.error_message_en);
        ...
        updateDevice(e, t) {
          return jt(this, null, function*() {
            var c;
            R.A.debug("Sending device id put request");
            const a = (0, Pt.sr)();
            try {
              return yield L.A.put(`${ft.W2}/v2/devices/${e}`, {
                legacy_device_id: t,
                type: "extension",
              ...
              R.A.debug("Device id put request failed", e)
            }
          })
        }
        getFingerprint(e) {
          return L.A.post(ft.W2 + "/v2/devices/fingerprint", {
            identifier: e,
            bundle: wt.RL,
            sr: vt.O0
          })
        ...
        getDevice(e) {
          return L.A.get(`${ft.W2}/v2/devices/${e}`)
        }
        warningDisplayed(e) {
          return L.A.put(`${ft.JR}/v1/devices/${e}/metrics`, {
            version: (0, kt.W9)()
          })
        }
        registerWallet(e, t, c, a, o) {
          return L.A.post(`${ft.W2}/v3/devices/${e}/wallets/${t}/register`, Ht(Nt({}, o ? {
            parent_wallet_id: o
          } : {}), {
            operation_type: a,
        ...
        registerCoin(e, t, c, a) {
          return L.A.post(`${ft.W2}/v3/devices/${e}/wallets/${t}/address_association`, Ht(Nt({}, a ? {
            parent_wallet_id: a
          } : {}), {
            coin: c.coin,
            address: c.address
        ...
        getAssets(e, t) {
          return jt(this, arguments, function*(e, t, c = xt.l.ALL, a = 0, o = Ot.DEFAULT_ASSETS_LIMIT) {
            ...
            return yield L.A.get(`${ft.W2}/v1/search/assets?networks=${e}&${n}`)
          })
        }
        getAsset(e) {
          return L.A.get(`${ft.W2}/v1/assets/${e}`)
        }
        getAssetBySymbol(e) {
          return L.A.get(`${ft.W2}/v1/assets/symbols/${e}`)
        }
        getAssetsBySymbols(e) {
          const t = e.join(",");
          return L.A.get(`${ft.W2}/v1/assets/symbols?symbols=${t}`)
        }
        getAssetsPerBlockchainAddress(e, t) {
          return L.A.post(ft.W2 + "/v1/assets", {
            assets: e,
            from_time: t,
            version: 13
          })
        ...
        getBep2Assets() {
          return L.A.get("https://dex.binance.org/api/v1/tokens?limit=10000")
        }
        fetchAssetChart(e) {
          return jt(this, null, function*() {
            return yield L.A.get(`${ft.W2}/v2/market/charts/${e.assetId}?currency=${e.currency}&period=${e.period}`)
          })
        }
        fetchHotTokenCategories() {
          return jt(this, null, function*() {
            return yield L.A.get(ft.W2 + "/v1/assets/listing-categories")
          })
        }
        fetchHotTokens(e, t, c, a) {
          return jt(this, null, function*() {
            ...
            return yield L.A.get(`${ft.W2}/v1/assets/listings?${r}`)
          })
        }
        fetchMarketInfo(e) {
          return jt(this, null, function*() {
            const t = (0, Pt.sr)();
            return yield L.A.get(`${ft.W2}/v2/market/info/${e}?currency=${t}`)
          })
        }
        fetchSimilarTokensCount(e) {
          return jt(this, null, function*() {
            return yield L.A.get(`${ft.W2}/v1/assets/symbols/similar/${e}/count`)
          })
        }
        fetchSimilarTokens(e) {
          return jt(this, null, function*() {
            return yield L.A.get(`${ft.W2}/v1/assets/symbols/similar/${e}`)
          })
        }
        getNFTCollections(e) {
          return jt(this, arguments, function*(e, t = 0, c = Ot.DEFAULT_NFTS_LIMIT) {
            ...
            return yield L.A.post(`${ft.W2}/v3/nft/collections?${a}`, {
              owners: e
            })
          })
        }
        getNFTCollectionItems(e, t, c) {
          return jt(this, arguments, function*(e, t, c, a = 0, o = Ot.DEFAULT_NFTS_LIMIT) {
            ...
            return yield L.A.get(`${ft.W2}/v3/nft/chains/${c.id}/collections/${e}/tokens?${s}`)
          })
        }
        getNFTMetadata(e, t, c) {
          return jt(this, null, function*() {
            return yield L.A.get(`${ft.W2}/v3/nft/chains/${c.id}/contracts/${e}/tokens/${t}`)
          })
        }
        buyCrypto(e, t, c, a) {
          return jt(this, null, function*() {
            return yield(0, L.A)(`${ft.W2}/v1/buycrypto/request/${e}?address=${t}&ts=${c}&sig=${a}`)
          })
        }
        buyCryptoQuote({
          coinId: e,
          ...
          return (0, L.A)(`${ft.W2}/v1/buycrypto/quotes/${e}?amount=${t}&address=${c}&currency=${a}&twt_amount=${o}&ts=${s}&sig=${r}`)
        }
        buyCryptoConfig(e, t, c = !0) {
          return jt(this, null, function*() {
            return (0, L.A)(`${ft.W2}/v3/buycrypto/config/${e}?wallet_id=w_${t}&is_asset_recommendation_required=${c}`)
          })
        }
        getBuyCryptoAssets(e) {
          return jt(this, null, function*() {
            return L.A.get(ft.W2 + "/v2/buycrypto/assets", {
              params: {
                wallet_id: "m_" + e.walletId,
                version: Ot.SEARCH_ASSETS_VERSION,
                query: e.query,
                all_network: e.allNetwork,
                all_limit: e.allLimit,
                all_offset: e.allOffset,
                top100_network: e.top100Network,
                top100_limit: e.top100Limit,
                top100_offset: e.top100Offset,
                stablecoins_network: e.stablecoinsNetwork,
                stablecoins_limit: e.stablecoinsLimit,
                stablecoins_offset: e.stablecoinsOffset
              }
            })
          })
        }
        getBuyProviderRoutes(e) {
          return jt(this, null, function*() {
            var t, c, a;
            return L.A.get(`${ft.W2}/v3/buycrypto/${e.assetId}/routes`, {
              params: {
                address: e.address,
                wallet_id: "m_" + e.walletId,
                currency: e.currency,
                amount: e.amount,
                is_binance_app_installed: null != (t = e.isBinanceAppInstalled) && t,
                platform: null != (c = e.platform) ? c : "extension",
                twt_amount: null != (a = e.twtAmount) ? a : "0"
              }
            })
          })
        }
        buyCryptoWidgetQuote(e) {
          return jt(this, arguments, function*({
            ...
            const r = s.flatMap(([e, t]) => `${e}=${t}`).join("&");
            return L.A.get(`${ft.W2}/v1/buycrypto/widget/quote?${r}`)
          })
        }
        sellCryptoQuote(e) {
          return jt(this, arguments, function*({
            ...
            return yield(0, L.A)(`${ft.W2}/v1/sellcrypto/quote/${e}?amount=${t}&address=${c}&currency=${a}&twt_amount=${o}&ts=${s}&sig=${r}`)
          })
        }
        sellCrypto(e, t, c, a) {
          return jt(this, null, function*() {
            return yield(0, L.A)(`${ft.W2}/v1/sellcrypto/request/${e}?address=${t}&ts=${c}&sig=${a}`)
          })
        }
        getCoinStatus(e, t) {
          const c = [];
          ...
          return (0, L.A)(`${ft.W2}/v1/coinstatus/${e}?${a}`)
        }
        getSwapPairsForBlockchain(e) {
          return (0, L.A)(`${ft.WL}/blockchains/${e}/tokenlist.json`)
        }
        getStakingList() {
          return (0, L.A)(ft.W2 + "/v1/discover/group/invest-staking?currency=USD")
        }
        validateAddress(e, t, c = "security_scanner") {
          return L.A.post(ft.W2 + "/v1/validate/address", {
            asset_id: t,
            address: e,
            version: 7,
            type: c
        ...
        validateDappUrl(e) {
          return L.A.post(ft.W2 + "/v1/validate/url", {
            dapp_url: e
          })
        }
        validateTransaction(e) {
          return L.A.post(ft.W2 + "/v1/validate/transaction", e)
        }
        validateMessage(e) {
          return L.A.post(ft.W2 + "/v1/validate/message", e)
        }
        getTransactionHistory(e, t, c, a, o, s, r) {
          return (0, L.A)(ft.W2 + "/v1/txhub/txs", {
            params: {
              asset: e,
              chain: t,
              address: c,
        ...
        getMultipleAssetTransactionHistory(e, t, c, a) {
          return L.A.post(ft.W2 + "/v1/txhub/bulk_history", {
            addresses: e,
            from: t,
            to: c,
            next_token: a
        ...
        togglePushNotifications(e, t, c) {
          return L.A.put(`${ft.W2}/v2/devices/${c}`, Nt({
            push_enabled: e
          }, e ? {
            push_token: t
          } : {}))
        ...
        updatePushNotificationTopics(e, t) {
          return L.A.put(`${ft.W2}/v2/devices/${t}/push-topics`, Nt({}, e))
        }
        fetchMarketSentimentSupportedCrypto() {
          return L.A.get(ft.W2 + "/v2/market/sentiment-assets")
        }
        fetchMarketSentiment(e) {
          return L.A.get(`${ft.W2}/v2/market/sentiment/${e}`)
        }
        getAnnouncements(e, t) {
          return (0, L.A)(`${ft.W2}/v2/announcements?strategy=prioritize_app_update&version=${e}&platform=extension&device_id=${t}`)
        }
        setSeenAnnouncements(e, t) {
          return L.A.post(ft.W2 + "/v2/announcements/seen", {
            device_id: e,
            announcement_ids: t
          })
        }
        fetchCexFundingAssets(e) {
          return L.A.get(`${ft.W2}/v1/cex-transfer/providers/${e}/assets`)
        }
        fetchCexFundingLink(e, t, c, a, o, s) {
          return L.A.get(`${ft.W2}/v1/cex-transfer/providers/${e}`, {
            params: {
              assetID: t,
              ts: o,
              walletAddress: c,
        ...
        fetchCexFundingTransferStatus(e, t) {
          return L.A.get(`${ft.W2}/v1/cex-transfer/providers/${e}/transactions/${t}`)
        }
        fetchTrendingTokens(e, t, c) {
          return L.A.get(ft.W2 + "/v1/homepage", {
            params: {
              wallet_id: "m_" + e,
              user_type: "new",
              coins: t.join(","),
        ...
        lookupDomainName(e, t) {
          return jt(this, null, function*() {
            try {
              const c = yield L.A.get(ft.wr + "/v1/lookup", {
                params: {
                  name: e,
                  coin: t
                }
              ...
              return R.A.debug("Domain name lookup failed", {
                name: e,
                coin: t,
                error: c
              }), null
        ...
        fetchRecommendedDapps(e) {
          return jt(this, null, function*() {
            return yield(0, L.A)(ft.JR + "/v3/dapps", {
              params: {
                networks: e.join(",")
              }
            })
        ...
        fetchApprovals(e) {
          return jt(this, null, function*() {
            return yield L.A.post(ft.W2 + "/v1/approvals/scan", e)
          })
        }
        fetchFundingMethods() {
          return jt(this, null, function*() {
            const {
              data: e
            } = yield L.A.get(ft.W2 + "/v1/buycrypto/screens/funding");
            return e
          })
        }
        getUserVipTierData(e) {
          return jt(this, null, function*() {
            return yield L.A.get(`${ft.W2}/v3/points/${e}/vip`)
          })
        }
        getP2PBuyCryptoConfig(e) {
          return jt(this, null, function*() {
            return L.A.get(ft.W2 + "/v1/buycrypto/p2p/config", {
              params: {
                wallet_id: "m_" + e
              }
            })
        ...
        getP2PBuyCryptoQuotes(e, t, c, a) {
          return jt(this, null, function*() {
            return L.A.get(ft.W2 + "/v1/buycrypto/p2p/quotes", {
              params: {
                wallet_id: "m_" + e,
                asset_id: t,
                amount: c,
        ...
        getP2PBuyCryptoCheckout(e, t, c, a) {
          return jt(this, null, function*() {
            return L.A.get(ft.W2 + "/v1/buycrypto/p2p/checkout", {
              params: {
                id: e,
                address: t,
                ts: c,
      ...
      let Rt = class {
        constructor() {
          this.hashKey = null, this.authIdentifier = null, this.devicePoller = new ut.v({
            interval: Rt.POLL_DEVICE_INTERVAL_MS
          })
        }
        ...
        onApplicationBoot() {
          return _t(this, null, function*() {
            const e = () => _t(this, null, function*() {
              try {
                const e = yield this.getDeviceId(), t = (0, pt.IP)(), c = (0, pt.P6)(), a = (0, pt.UN)();
                e && e !== t && (R.A.debug("Settings fresh device id version"), Q.M_.dispatch(dt.A.actions.setDeviceId(e)), yield this.walletKitService.SwapService.setDeviceId(e), c && !a ? (yield this.apiService.updateDevice(e, c), Q.M_.dispatch(dt.A.actions.setNewAuthMigrated(!0))) : yield this.apiService.updateDevice(e)), (e || t) && this.devicePoller.stop()
              } catch (e) {
                R.A.error(e)
              }
            });
            this.devicePoller.start(e.bind(this)), e().catch(R.A.error), Q.M_.getState().app.hashKey && (this.hashKey = Q.M_.getState().app.hashKey, yield de.SwapService.setHashKey(this.hashKey)), Q.M_.getState().app.authIdentifier && (this.authIdentifier = Q.M_.getState().app.authIdentifier, yield de.SwapService.setIdentifier(this.authIdentifier)), Q.M_.subscribe(() => _t(this, null, function*() {
        ...
        fetchDeviceDetails() {
          return _t(this, null, function*() {
            ...
            } else c && (yield new mt.f(() => _t(this, null, function*() {
              R.A.debug("Sending an update of the legacy device Id"), yield this.apiService.updateDevice(e, c), Q.M_.dispatch(dt.A.actions.setNewAuthMigrated(!0))
            }), {
              maxAttempts: 5,
              wait: 1e3,
              incrementalWait: !0
        ...
        register() {
          return _t(this, null, function*() {
            const e = yield(0, ht.U)(), t = yield this.apiService.getFingerprint(e);
            return Q.M_.dispatch(dt.A.actions.setHashKey(t?.data.hash_key)), t?.data.device_id
          })
        }
      };
      Rt.POLL_DEVICE_INTERVAL_MS = 6e4, Mt([pe(Ot)], Rt.prototype, "apiService", 2), Mt([pe(ge)], Rt.prototype, "storageService", 2), Mt([pe(J.r)], Rt.prototype, "walletKitService", 2), Rt = Mt([(0, te.k)(), (0, ce.x)(10)], Rt);
      var Lt = c(49971),
        Ut = c(93038),
        Vt = (e => (e.CREATE = "create", e.IMPORT = "import", e.VERSION_UPDATE = "version_update", e))(Vt || {}),
      ...
      let Zt = class {
        onApplicationBoot() {
          Jt(this, null, function*() {
            ...
            this.appIsStale() && (yield this.deviceService.deviceSync(), (0, Ut.Ic)(Ut.wN.REGISTER_WALLET, {
              operationType: Vt.VERSION_UPDATE
        ...
        fetchAnnouncements() {
          return Jt(this, null, function*() {
            ...
            if (!e || !t) return void R.A.warn("No deviceId or appVersion found while fetching announcements");
            const c = yield this.apiService.getAnnouncements(t, e);
            return c ? (0, Lt.Sg)(c.data.announcements) : void 0
          })
        }
        setAnnouncementDisplayed(e) {
          ...
          if (t) {
            ...
            R.A.warn("No ids passed to setting announcement displayed")
          } else R.A.warn("No device id found while fetching announcements")
        }
      ...
      Xt([pe(nt)], Zt.prototype, "vaultService", 2), Xt([pe(Rt)], Zt.prototype, "deviceService", 2), Xt([pe(ge)], Zt.prototype, "storageService", 2), Xt([pe(Ot)], Zt.prototype, "apiService", 2), Zt = Xt([(0, te.k)(), (0, ce.x)(9)], Zt);
      var Yt = c(67881),
      ...
      let dc = class {
        onApplicationBoot() {
          ...
          }).catch(R.A.error), this.checkMemo()
        }
        checkMemo() {
        ...
        static getBlockchainsSupporting7702() {
          const e = [];
          return Qt(Yt.$o).enabled && e.push(Be.J.ethereum), Qt(Yt.c3).enabled && e.push(Be.J.smartchain), Qt(Yt.cv).enabled && e.push(Be.J.optimism), Qt(Yt.qw).enabled && e.push(Be.J.arbitrum), Qt(Yt.LY).enabled && e.push(Be.J.base), Qt(Yt.I4).enabled && e.push(Be.J.solana), e
        }
        ...
        fetchBlockchains() {
          ...
          return he.map(c => ((e, t) => tc(e, ac(t)))(((e, t) => {
          ...
          return pc(this, null, function*() {
            try {
              ...
              return {
                ...
                medium: W(n, i, 1),
                high: W(n, i, 2),
                estimatedBaseFee: (0, V.fromWei)(i, "gwei")
              }
            } catch (e) {
              R.A.error(e, "Blockchain service - Failed to estimate gas fees manually.")
            }
          })
        }
        estimateFees(e) {
          return pc(this, null, function*() {
            try {
              return yield(0, L.h)(`https://gas-api.metaswap.codefi.network/networks/${+e.chainId}/suggestedGasFees`).then(e => e.data)
            } catch (t) {
              return R.A.warn("Call Gas API failed: ", t), R.A.warn("Use a fallback to get estimated values."), yield this.getEstimateEIP1559GasFees(e)
            }
          })
        }
        ...
        assignWalletKitNodes() {
          return pc(this, null, function*() {
            ...
            })).catch(e => R.A.error("Wallet kit node override failed", e))
          })
        }
      ...
      dc.CUSTOM_DAPP_BLOCKCHAIN_PREFIX = "dapp-custom-network", nc([pe(Zt)], dc.prototype, "appService", 2), nc([pe(He)], dc.prototype, "walletCoreService", 2), nc([pe(J.r)], dc.prototype, "walletKitService", 2), dc = nc([(0, te.k)(), (0, ce.x)(8)], dc);
      var lc = c(87841),
        hc = c(69275),
        uc = c(33055);
      ...
      function u(e) {
        return l(this, null, function*() {
          ...
          const u = 403 === (null == (t = e.response) ? void 0 : t.status),
            m = null == (l = null == (c = e.response) ? void 0 : c.config.url) ? void 0 : l.startsWith(s.W2);
          if (u && m && !h) {
            h = !0;
            const e = yield(0, n.U)();
