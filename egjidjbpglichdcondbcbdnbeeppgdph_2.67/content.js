try {
  let e = "u" > typeof window ? window : "u" > typeof global ? global : "u" > typeof globalThis ? globalThis : "u" > typeof self ? self : {},
    n = (new e.Error).stack;
  n && (e.i = e.i || {}, e.i[n] = "b7570de7-ec81-4e36-b4a6-663df710b8bd", e.u = "sentry-dbid-b7570de7-ec81-4e36-b4a6-663df710b8bd")
  ...
  var e, n, t = {
      ...
      37007: e => {
        ...
        }, o.EventEmitter = o, o.prototype.m = void 0, o.prototype.l = 0, o.prototype.A = void 0;
        var s = 10;
        ...
        function u(e) {
          return void 0 === e.A ? o.defaultMaxListeners : e.A
        }

        function c(e, n, t, r) {
          var i, o, s;
          if (a(t), void 0 === (o = e.m) ? (o = e.m = Object.create(null), e.l = 0) : (void 0 !== o.newListener && (e.emit("newListener", n, t.listener ? t.listener : t), o = e.m), s = o[n]), void 0 === s) s = o[n] = t, ++e.l;
        ...
        Object.defineProperty(o, "defaultMaxListeners", {
          ...
          (void 0 === this.m || this.m === Object.getPrototypeOf(this).m) && (this.m = Object.create(null), this.l = 0), this.A = this.A || void 0
          ...
          var t, r, i, o, s;
          if (a(n), void 0 === (r = this.m)) return this;
          if (void 0 === (t = r[e])) return this;
          if (t === n || t.listener === n) 0 === --this.l ? this.m = Object.create(null) : (delete r[e], r.removeListener && this.emit("removeListener", e, t.listener || n));
          ...
          var n, t, r;
          if (void 0 === (t = this.m)) return this;
          if (void 0 === t.removeListener) return 0 === arguments.length ? (this.m = Object.create(null), this.l = 0) : void 0 !== t[e] && (0 === --this.l ? this.m = Object.create(null) : delete t[e]), this;
          if (0 === arguments.length) {
            var i, o = Object.keys(t);
            for (r = 0; r < o.length; ++r) "removeListener" !== (i = o[r]) && this.removeAllListeners(i);
            return this.removeAllListeners("removeListener"), this.m = Object.create(null), this.l = 0, this
          }
              ...
              t = e => {
                ...
                const u = (e, n = {}, t = {}) => {
                  ...
                  l = ({
                    ...
                    e.runtime.lastError ? e.runtime.lastError.message === n ? r() : t(Error(e.runtime.lastError.message)) : i && i.h ? t(Error(i.message)) : r(i)
                  },
                  f = (e, n, t, ...r) => {
                    if (r.length < n.minArgs) throw Error(`Expected at least ${n.minArgs} ${o(n.minArgs)} for ${e}(), got ${r.length}`);
                    if (r.length > n.maxArgs) throw Error(`Expected at most ${n.maxArgs} ${o(n.maxArgs)} for ${e}(), got ${r.length}`);
  ...
  i.n = e => {
    var n = e && e.v ? () => e.default : () => e;
    return i.d(n, {
      a: n
    }), n
  }, n = Object.getPrototypeOf ? e => Object.getPrototypeOf(e) : e => e.__proto__, i.t = function(t, r) {
    if (1 & r && (t = this(t)), 8 & r || "object" == typeof t && t && (4 & r && t.v || 16 & r && "function" == typeof t.then)) return t;
    ...
    var a = {
      ...
      canBeUsed: function() {
        ...
        if (("u" > typeof window || "u" > typeof self) && "function" == typeof BroadcastChannel) {
          if (BroadcastChannel.p) throw Error("BroadcastChannel: Do not overwrite window.BroadcastChannel with this module, this is not a polyfill");
          return !0
        }
        return !1
      },
    ...
    class u {
      ...
      add(e) {
        this.map.set(e, c()), this.T || (this.T = !0, setTimeout(() => {
          this.T = !1,
            function(e) {
              const n = c() - e.ttl,
    ...
    var y = {
        create: function(e, n) {
          if (n = g(n), !w()) throw Error("BroadcastChannel: localstorage cannot be used");
          var t = r(),
      ...
      S = function(e, n) {
        this.id = R++, N.add(this), this.name = e, this.options = g(n), this.method = function(e) {
          ...
          }(this.options), this.C = !1, this.N = null, this.R = {
            message: [],
            internal: []
          }, this.S = new Set, this.P = [], this.O = null,
          function(e) {
            var n = e.method.create(e.name, e.options);
            ! function(e) {
              return e && "function" == typeof e.then
            }(n) ? e.k = n: (e.O = n, n.then(function(n) {
              e.k = n
            }))
          }(this)
      };
    ...
    function P(e, t, r) {
      ...
      return (e.O ? e.O : n).then(function() {
        var n = e.method.postMessage(e.k, i);
        return e.S.add(n), n.catch().then(function() {
          return e.S.delete(n)
        }), n
      })
    }
    ...
    function O(e) {
      return e.R.message.length > 0 || e.R.internal.length > 0
    }
    ...
    function k(e, n, t) {
      e.R[n].push(t),
        function(e) {
          if (!e.C && O(e)) {
            var n = function(n) {
                e.R[n.type].forEach(function(e) {
                  n.time >= e.time && e.fn(n.data)
                })
              },
              t = e.method.microSeconds();
            e.O ? e.O.then(function() {
              e.C = !0, e.method.onMessage(e.k, n, t)
            }) : (e.C = !0, e.method.onMessage(e.k, n, t))
          }
        }(e)
    }
    ...
    S.p = !0, S.prototype = {
      ...
      set onmessage(e) {
        ...
        B(this, "message", this.N), e && "function" == typeof e ? (this.N = n, k(this, "message", n)) : this.N = null
      },
      ...
      removeEventListener: function(e, n) {
        B(this, e, this.R[e].find(function(e) {
          return e.fn === n
        }))
      },
      close: function() {
        ...
        if (!this.closed) {
          ...
          var t = this.O ? this.O : n;
          return this.N = null, this.R.message = [], t.then(function() {
            return Promise.all(Array.from(e.S))
          }).then(function() {
            return Promise.all(e.P.map(function(e) {
              return e()
            }))
          }).then(function() {
            return e.method.close(e.k)
          })
        }
      },
      get type() {
    ...
    var $, W = (($ = W || {})[$.Bitcoin = 0] = "Bitcoin", $[$.Ethereum = 60] = "Ethereum", $[$.Tron = 195] = "Tron", $[$.Solana = 501] = "Solana", $[$.Arbitrum = 42161] = "Arbitrum", $[$.Base = 8453] = "Base", $[$.SmartChain = 20000714] = "SmartChain", $),
      H = (e => (e[e.CRYPTO = 0] = "CRYPTO", e[e.NFT = 1] = "NFT", e[e.APPROVALS = 2] = "APPROVALS", e))(H || {}),
      K = (e => (e[e.RWA = 0] = "RWA", e[e.AI = 1] = "AI", e[e.MEMES = 2] = "MEMES", e))(K || {}),
      Y = (e => (e[e.TOP = 0] = "TOP", e[e.BNB = 1] = "BNB", e[e.ETH = 2] = "ETH", e[e.SOL = 3] = "SOL", e))(Y || {}),
      J = (e => (e[e.HOLDINGS = 0] = "HOLDINGS", e[e.HISTORY = 1] = "HISTORY", e[e.ABOUT = 2] = "ABOUT", e))(J || {}),
      V = (e => (e.READY = "READY", e.LOADING = "LOADING", e.IDLE = "IDLE", e.RESTARTING = "RESTARTING", e))(V || {});
    class q extends(M()) {
      constructor() {
    ...
    q.EVENT = "EVENT", q.REPLACED = "REPLACED";
    var Z = i(73065),
      X = i.n(Z),
      z = i(90251),
      Q = i.n(z),
    ...
    const {
      ...
      argv: ie = [],
      platform: oe = ""
    } = typeof te > "u" ? {} : te, se = "NO_COLOR" in re || ie.includes("--no-color"), ae = "FORCE_COLOR" in re || ie.includes("--color"), ue = "win32" === oe, ce = "dumb" === re.TERM, ge = ne && ee.isatty && ee.isatty(1) && re.TERM && !ce, me = !se && (ae || ue && !ce || ge || "CI" in re && ("GITHUB_ACTIONS" in re || "GITLAB_CI" in re || "CIRCLECI" in re)), le = (e, n, t, r, i = n.substring(0, e) + r, o = n.substring(e + t.length), s = o.indexOf(t)) => i + (0 > s ? o : le(s, o, t, r)), fe = (e, n, t) => ((e, n, t = e, r = e.length + 1) => i => i || "" !== i && void 0 !== i ? ((e, n, t, r, i) => 0 > e ? t + n + r : t + le(e, n, r, i) + r)(("" + i).indexOf(n, r), i, e, n, t) : "")(`[${e}m`, `[${n}m`, t), Ae = {
      reset: fe(0, 0),
      bold: fe(1, 22, "[22m[1m"),
      dim: fe(2, 22, "[22m[2m"),
      italic: fe(3, 23),
      ...
      bgCyan: fe(46, 49),
      bgWhite: fe(47, 49),
      blackBright: fe(90, 39),
      redBright: fe(91, 39),
      greenBright: fe(92, 39),
      yellowBright: fe(93, 39),
      blueBright: fe(94, 39),
      magentaBright: fe(95, 39),
      cyanBright: fe(96, 39),
      whiteBright: fe(97, 39),
      bgBlackBright: fe(100, 49),
      bgRedBright: fe(101, 49),
      bgGreenBright: fe(102, 49),
      bgYellowBright: fe(103, 49),
      bgBlueBright: fe(104, 49),
      bgMagentaBright: fe(105, 49),
      bgCyanBright: fe(106, 49),
      bgWhiteBright: fe(107, 49)
    }, {
      reset: he,
      bold: de,
      dim: ve,
      ...
      useColor: e = me
    } = {}) => e ? Ae : Object.keys(Ae).reduce((e, n) => ({
      ...e,
      [n]: String
    }), {}))();
    X().setLevel("silent");
    var tn = (e => (e.TRACE = "TRACE", e.DEBUG = "DEBUG", e.INFO = "INFO", e.WARN = "WARN", e.ERROR = "ERROR", e))(tn || {});
    const rn = {
      TRACE: Se,
      DEBUG: Pe,
      INFO: Re,
    ...
    Q().reg(X()), Q().apply(X(), {
      format: (e, n, t) => `${ke(`[${t}]`)} ${rn[e](e)}${"root"===n?"":Ce(` [${n}:]`)}`
    });
    const on = X().error.bind(X());
    X().error = (...e) => on(...e);
    const sn = X();
    var an = (e => (e.INTERNAL = "INTERNAL", e.PUBLIC = "PUBLIC", e))(an || {});
    ...
    const mn = {
        RESET: cn("Reset"),
        LOCK: cn("Lock"),
        LOCK_CALLBACK: cn("Lock_callback"),
        AUTHENTICATE: cn("Authenticate"),
        REGISTER_DEVICE: cn("RegisterDevice"),
        APP_DISPLAYED: cn("AppDisplayed"),
        WARNING_DISPLAYED: cn("WarningDisplayed"),
        ICON_THEME_CHANGED: cn("IconThemeChanged"),
        OPEN_POPUP: cn("OpenPopup"),
        GET_APP_SETTINGS: gn("GetAppSettings"),
        GET_APP_NODES: gn("GetAppNodes"),
        GET_STORE: cn("GetStore"),
        GET_REDUX_STATE: cn("GetReduxState"),
        DISPATCH_REDUX_ACTION: cn("DispatchReduxAction"),
        PING: gn("Ping"),
        GET_ONE_TAP_SETTINGS: gn("GetOneTapSettings"),
        ONE_TAP_DISMISS: gn("OneTapDismiss"),
        ONE_TAP_CONNECT: gn("OneTapConnect"),
        GET_TOKEN_SCANNER_I18N: gn("GetTokenScannerI18n"),
        GET_TOKEN_SCANNER_ENABLED: gn("GetTokenScannerEnabled"),
        GET_TOKEN_BASIC_INFO: gn("GetTokenBasicInfo"),
        GET_TOKEN_MARKET_DATA: gn("GetTokenMarketData"),
        GET_SIMILAR_TOKENS_COUNT: gn("GetSimilarTokensCount"),
        GET_SIMILAR_TOKENS: gn("GetSimilarTokens"),
        OPEN_SWAP_PAGE: gn("OpenSwapPage"),
        GET_FEATURE_FLAG: gn("GetFeatureFlag"),
        SET_TOKEN_SCANNER_ENABLED: gn("SetTokenScannerEnabled"),
        TRACK_ANALYTICS: gn("TrackAnalytics"),
        ANNOUNCEMENT_DISPLAYED: cn("AnnouncementDisplayed"),
        FETCH_ANNOUNCEMENTS: cn("FetchAnnouncements"),
        FETCH_USER_VIP_TIER_DATA: cn("FetchUserVipTierData"),
        FETCH_FUNDING_METHODS: cn("FetchFundingMethods"),
        ROUTE_CHANGED: cn("RouteChanged")
      },
      ln = e => new Promise(n => setTimeout(n, e));

    function fn(e) {
      return e.portStream ? Promise.race([e.portStream.emit(mn.PING), ln(e.FIRST_TIME_WAIT).then(() => V.IDLE)]) : Promise.resolve(V.IDLE)
    }
    ...
    function An(e) {
      return ((e, n, t) => new Promise((n, r) => {
        ...
        e.checking || (e.checking = !0, (yield fn(e)) === V.IDLE ? e.missCount++ : e.statusProvider.emit(q.EVENT, V.READY), e.missCount >= e.MAX_MISS_RECONNECT && (e.statusProvider.emit(q.EVENT, V.LOADING), e.portStream = new F(e.portName), e.statusProvider.emit(q.REPLACED, V.LOADING), e.missCount = 0), e.checking = !1, setTimeout(() => An(e), e.THRESHOLD))
      })
    }
    ...
    function hn(e) {
      return new Promise(n => {
        fn(e).then(t => {
          t === V.READY ? (n(e), An(e)) : (e.portStream = new F(e.portName), e.statusProvider.emit(q.REPLACED, V.LOADING), fn(e).then(t => {
            t === V.READY ? (e.statusProvider.emit(q.EVENT, V.READY), n(e), An(e)) : n(ln(e.RETRY_THRESHOLD).then(() => hn(e)))
          }).catch(sn.error))
        }).catch(sn.error)
      })
    }
    const dn = ["facebook.com", "instagram.com", "twitter.com", "tiktok.com", "linkedin.com", "snapchat.com"];
    if (function({
        hostname: e = location.hostname
      }) {
        return dn.some(n => e === n || e.endsWith("." + n))
      }({
        hostname: new URL(window.location.origin).hostname
      })) throw Error("Injection blocked for this domain");
    const vn = "in_page_channel_" + e(6);
    ! function(e) {
    ...
    const pn = new class extends _ {
        constructor(e) {
          super(), this.port = new S(e), this.port.addEventListener("message", e => {
            const n = e.method;
            !n || !this.listeners[n] || this.listeners[n].forEach(n => n(e))
          })
        }
      ...
      bn = {
        ...
        statusProvider: new q
      },
      wn = new Proxy({}, {
        get: (e, n, t) => Reflect.get(bn.portStream, n, t)
      });
    let yn;
    (function() {
      return ((e, n, t) => new Promise((n, r) => {
        ...
        function e(n, t) {
          return new Promise(r => {
            n.statusProvider.status === V.READY ? r(t()) : setTimeout(() => r(e(n, t)), n.THRESHOLD)
          })
        }
        bn.statusProvider.on(q.REPLACED, () => {
          yn && yn(), yn = wn.listen(e => {
            var n;
            return (null == (n = e.method) ? void 0 : n.endsWith("_callback")) && pn.send(e)
          })
        }), pn.listen(n => {
          var t;
          if (null == (t = n.method) || !t.endsWith("_callback")) return e(bn, () => wn.send(n))
        }), U.runtime.onMessage.addListener(e => pn.send(e)), yield hn(bn)
      })
    })().catch(sn.error).then(() => sn.debug("content started"))
  })()
})();
