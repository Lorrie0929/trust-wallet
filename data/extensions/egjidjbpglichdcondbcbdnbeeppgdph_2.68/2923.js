...
(self.webpackChunkbrowser_extension_wallet = self.webpackChunkbrowser_extension_wallet || []).push([
  [2923], {
    ...
    62923: (e, t, a) => {
      ...
      var x = (e => (e[e.Coin = C.wL.Send] = "Coin", e[e.Token = C.wL.Send] = "Token", e[e.Swap = C.wL.Swap] = "Swap", e[e.Dapp = C.wL.Contract] = "Dapp", e))(x || {}),
        v = a(86170),
        b = a(66118),
        M = a(44731),
        N = a(5638),
        ...
        B = (e, t, a) => t in e ? H(e, t, {
          enumerable: !0,
          configurable: !0,
          writable: !0,
          value: a
        }) : e[t] = a;
      b.t1.register(b.PP, b.ZT, b.No, b.kc, b.FN, b.dN, N.A);
      const G = ({
          history: e,
          ...
          const [n, r] = (0, g.useState)(null), l = (0, g.useRef)(null), {
            theme: o
            ...
            afterDraw: e => {
              if (e.getActiveElements().length) {
                ...
                return r(n), t.save(), t.beginPath(), t.moveTo(n.element.x, a.top), t.lineTo(n.element.x, a.bottom), t.lineWidth = 1, t.setLineDash([3, 3]), t.strokeStyle = s, t.stroke(), t.restore(), t.beginPath(), t.arc(n.element.x, n.element.y, 5, 0, 2 * Math.PI), t.fillStyle = s, t.fill(), t.lineWidth = 2, t.strokeStyle = i, t.stroke(), void t.restore()
              }
              r(null)
            }
          }], []), v = (0, g.useCallback)((0, j.debounce)(e => {
          ...
          }, 100), []), b = (0, g.useCallback)(e => {
            c.current = e, v(e)
          }, [v]);
          (0, g.useEffect)(() => {
            n?.index !== c.current && (void 0 !== n?.index ? b(n.index) : null === n && b(e.xAxis.length - 1))
          }, [n, b]), (0, g.useEffect)(() => () => {
            v.cancel()
          }, [v]);
          const N = (0, g.useMemo)(() => ({
        ...
        R = e => e?.history ? (0, i.jsx)(G, ((e, t) => {
          for (var a in t || (t = {})) F.call(t, a) && B(e, a, t[a]);
          if (A)
            for (var a of A(t)) V.call(t, a) && B(e, a, t[a]);
          return e
        })({}, e)) : (0, i.jsx)(k.E, {
          isLoading: !0,
      ...
      const K = () => {
        ...
        return s?.isSuccess ? (0, i.jsxs)(r.LN, {
