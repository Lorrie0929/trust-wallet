  ...
  [9769], {
    5750: (e, t, a) => {
      ...
      const k = ({
        ...
        const {
          formatMessage: M
        } = (0, y.A)(), [P, N] = (0, v.useState)(""), I = (0, w.g)(!0), K = (0, v.useMemo)(() => I.find(t => {
          var a;
          return t.id === (null == (a = e?.[0]) ? void 0 : a.blockchainId)
        }), [I, e]), W = (0, v.useMemo)(() => a ? I.filter(e => a.includes((0, f.er)(e.coinId))).filter(e => {
          var t;
          return (null != (t = e.displayName) ? t : e.name).toLowerCase().includes(P.toLowerCase()) || e.id === K?.id
        }) : I.filter(e => {
          var t;
          return (null != (t = e.displayName) ? t : e.name).toLowerCase().includes(P.toLowerCase()) || e.id === K?.id
        }), [I, a, P, K]), O = e => ((e, t, a) => new Promise((e, t) => {
          var l = e => {
              try {
                s(a.next(e))
              } catch (e) {
          ...
          children: ({
            ...
            return (0, i.jsxs)(i.Fragment, {
              children: [x && (0, i.jsx)("div", {
                ...
                className: `outline-none bg-background-2 ${R[C]} ${T[k]} ${S?"w-full":""}`,
    ...
    69769: (e, t, a) => {
      ...
      const y = ({
        ...
        const [c, m] = (0, u.useState)(!1), p = (0, u.useRef)(null), [h, y] = (0, u.useState)(!e), [x, C] = (0, u.useState)(e);
        (0, u.useEffect)(() => {
          e && y(!1)
        }, [e]);
        const k = h ? "" : o,
        ...
        return (0, l.jsxs)("div", {
          ...
          children: [t && (0, l.jsx)("div", {
            ...
            children: (0, l.jsx)(w.E, {
              testid: "input-error",
              type: v.jK.CAPTION_12,
              theme: v.Il.ERROR_1_DEFAULT,
              children: k
            })
          })]
        })
      ...
      var P = a(90749),
        ...
        T = (e, t) => {
          ...
          if (W)
            for (var a of W(t)) V.call(t, a) && R(e, a, t[a]);
          return e
        },
        L = (e, t) => I(e, K(t)),
        E = a(16665),
      ...
      const Z = ({
        ...
        return (0, l.jsxs)("div", {
          ...
          children: [(0, l.jsx)(j.fu, {
            as: u.Fragment,
            onChange: e => o(e),
            selectedIndex: s,
            children: (0, l.jsx)(j.wb, {
              className: "flex gap-6",
              children: e?.platforms.map((t, a) => (0, l.jsx)(j.oz, {
                ...
                children: ({
                  ...
                  children: [(0, l.jsx)("div", {
                    ...
                    children: (0, l.jsx)(w.E, {
                      theme: e ? v.Il.UTILITY_1_DEFAULT : v.Il.UTILITY_1_OPACITY_2,
            ...
            children: [(0, l.jsx)("div", {
              ...
              children: (0, l.jsx)(_.M, {
                ...
                children: c.map((e, t) => (0, l.jsx)(_.M.Step, {
                  active: n === t
                }, e))
              })
            })]
      ...
      var B = a(38533),
        ...
        U = a(42394),
        J = a(93420);
      const Q = a.p + "images/trust-wallet-1.3J3Nz9y.gif",
        Y = a.p + "images/trust-wallet-2.gbIyt1J.gif",
        X = a.p + "images/trust-wallet-3.PdzvScD.gif",
        ee = a.p + "images/trust-wallet-extension-1.KcMJSCQ.gif",
        te = a.p + "images/trust-wallet-extension-2.411HMJ5.gif",
        ae = a.p + "images/trust-wallet-extension-3.bZWmQFy.gif",
        le = a.p + "images/phantom-mobile-1.ig1Cenu.gif",
        ie = a.p + "images/phantom-mobile-2.qDWnGBk.gif",
        se = a.p + "images/phantom-mobile-3.U1fXPIh.gif",
        oe = a.p + "images/phantom-extension-1.0uZqZ68.gif",
        re = a.p + "images/phantom-extension-2.yiQ5b5n.gif",
        ne = a.p + "images/phantom-extension-3.U1fXPIh.gif",
        de = a.p + "images/coinbase-mobile-1.6lmG22O.gif",
        ce = a.p + "images/coinbase-mobile-2.l3AMfKY.gif",
        me = a.p + "images/coinbase-mobile-3.HWvnBnq.gif",
        pe = a.p + "images/metamask-mobile-1.kkKjNUo.gif",
        ue = a.p + "images/metamask-mobile-2.CjjuEbb.gif",
        he = a.p + "images/metamask-mobile-3.LiwhwRp.gif",
        ge = a.p + "images/metamask-extension-1.50ms+Vm.gif",
        be = a.p + "images/metamask-extension-2.3A5cawg.gif",
        fe = a.p + "images/metamask-extension-3.88COOGz.gif",
        we = ({
          src: e,
          alt: t
        }) => (0, l.jsx)("div", {
        ...
        ye = a.p + "images/generic-2.WZnmcqG.gif",
        xe = a.p + "images/generic-3.eL0ymBo.gif",
        Ce = {
          "trust-wallet": {
            product: J.c.TRUST_WALLET,
            header: {
      ...
      const Ke = ({
        ...
        const f = function() {
          ...
          } = (0, q.B)(),
          {
            ...
            return {
              importMnemonic: (s, n) => ((e, t, a) => new Promise((e, t) => {
                ...
                const u = yield S.YW.emit(B.A.INITIATE_IMPORT_MNEMONIC, {
                  mnemonic: s
                }), {
                  types: h,
                  accounts: g
                } = yield S.YW.emit(B.A.DERIVE_SOLANA_ADDRESS, u), b = s.split(" ").length;
                1 === h.length ? (yield S.YW.emit(B.A.COMPLETE_IMPORT_MNEMONIC, {
                  walletId: u,
                  ...
                  props: {
                    ...
                    walletType: D.S.MNEMONIC,
                    mnemonicLength: b,
                    actionSourceType: "importwallet",
                    setupType: c
                  }
                }), a({
                  [p.nk.ONBOARDING_AUTH_TYPE]: l ? $.YO.BIOMETRICS : $.YO.PASSWORD,
                  [p.nk.ONBOARDING_SETUP_TYPE]: $.xO.IMPORT,
                  [p.nk.ONBOARDING_SELECTED_WALLET]: m,
                  [p.nk.ONBOARDING_WALLET_TYPE]: $.r9.SEED_PHRASE
          ...
          }),
          {
            ...
            return {
              importPrivateKey: (s, n, c) => ((e, t, a) => new Promise((e, t) => {
                ...
                const m = yield S.YW.emit(B.A.INITIATE_IMPORT_PRIVATE_KEY, {
                  privateKey: s,
                  blockchain: n
                });
                if (!m) throw Error("Private key import initiation failed");
                yield S.YW.emit(B.A.COMPLETE_IMPORT_PRIVATE_KEY, {
                  walletId: m,
                  walletName: c
                }), i(), t({
                  event: p.BQ.WALLET_CREATED,
                  ...
                  [p.nk.ONBOARDING_WALLET_TYPE]: $.r9.PRIVATE_KEY
                }), i(), e(d.jK.COMPLETED)
              })
            }
          })({
          ...
          ce = (e => {
            ...
            const {
              formatMessage: a
            } = (0, h.A)(), l = (0, Se.S)(), i = Object.values(null != (t = l?.wallets) ? t : {}).map(e => e.name), s = (0, u.useMemo)(() => i.includes(e), [e]);
            return {
              isValid: !s,
              error: s ? a({
            ...
            const {
              ...
              (0, u.useEffect)(() => {
                i(T({}, (({
                  ...
                  if (!e || 8 > e.length) return L(T({}, s), {
                    isValid: !1
                  });
                  const o = null != (i = null == (l = null == (a = e?.match(/\w+/g)) ? void 0 : a.join(" ").split(/\s/)) ? void 0 : l.length) ? i : 0;
                  e && (18 === o && 18 === t || 12 === o && 12 === t || 24 === o && 24 === t) ? (s.length = !0, s.mnemonic = P.JB(e.toLowerCase()), s.hideError = !1) : o > 24 ? s.length = !1 : s.hideError = !0;
              ...
              value: e,
              selectedWordCount: e.split(" ").length
            }), {
              isValid: o,
              error: r
            } = function({
        ...
        const he = e => ((e, t, a) => new Promise((e, t) => {
            ...
            var t;
            if (e?.preventDefault(), g || W) {
              te(!0), j({
                seedPhrase: oe ? Y.toLowerCase() : void 0,
              ...
              try {
                W && (yield F({
                  ...
                  passkeyPassword: R,
                  isPasswordGenerated: O
                })), oe ? yield A(Y.toLowerCase(), ne): yield _(Y, ie?.[0].blockchainId, ne)
              } catch (e) {
                "MNEMONIC_ALREADY_EXISTS" === e?.message ? le(a({
                  id: "import-wallet.seed-phrase.duplicated"
                })) : e?.message === U.p.DUPLICATED ? le(a({
        ...
        return (0, l.jsx)(r.Q, {
          ...
          activeTab: 3,
          subHeadingAction: Q && N === J.c.TRUST_WALLET ? (0, l.jsxs)(H.$, {
            theme: Pe.ry.TRANSPARENT,
            onClick: () => {
              I(d.nL.IMPORT_QR)
            },
            className: "text-primary-default flex items-center gap-2",
            fullWidth: !1,
            children: [(0, l.jsx)(Me.l, {
              width: 16,
              height: 16
            }), a({
          ...
          onBackClick: () => {
            N !== J.c.TRUST_WALLET ? e(d.jK.SELECT_IMPORT_METHOD) : e(d.jK.SELECT_TRUST_WALLET_METHOD)
          },
      ...
      var We = Object.defineProperty,
        ...
        He = (e, t) => {
          for (var a in t || (t = {})) Te.call(t, a) && Ee(e, a, t[a]);
          if (Re)
            for (var a of Re(t)) Le.call(t, a) && Ee(e, a, t[a]);
          return e
        },
        je = (e, t) => Oe(e, Ve(t));
      const Fe = ({
        ...
        return (0, l.jsx)(r.Q, {
          ...
          children: (0, l.jsxs)("form", {
            onSubmit: t => ((e, t, a) => new Promise((e, t) => {
              ...
              t.preventDefault();
              try {
                C(!0), yield S.YW.emit(B.A.COMPLETE_IMPORT_MNEMONIC, {
                  walletId: g,
            ...
            children: [f.map(e => (0, l.jsx)(ze.c, {
              ...
              children: (0, l.jsxs)("div", {
                ...
                children: [(0, l.jsxs)("div", {
                  ...
                  children: [(0, l.jsx)("div", {
                    children: e.type === De.a.DEFAULT ? (0, l.jsx)(_e, {}) : (0, l.jsx)(Ge, {
                      width: 15,
                      height: 30
                    })
                  }), (0, l.jsx)("div", {
                    ...
                    children: (0, l.jsxs)("div", {
                      ...
                      children: [(0, l.jsx)(w.E, {
                        type: v.jK.TITLE,
                        theme: v.Il.PRIMARY,
                        children: e.type === De.a.DEFAULT ? "Trust" : "Phantom"
                      }), (0, l.jsx)(w.E, {
                        type: v.jK.BODY,
                        theme: v.Il.THIRD,
                        children: (0, Be.p)({
                  ...
                  children: [(0, l.jsxs)(w.E, {
                    ...
                    children: k === e.type && (0, l.jsx)(Ze.S, {
                      width: 20,
                      height: 20,
      ...
      const et = () => {
        const e = (0, i.F)(),
          ...
          c = ((e, t) => {
            for (var a in t || (t = {})) Qe.call(t, a) && Xe(e, a, t[a]);
            if (Je)
              for (var a of Je(t)) Ye.call(t, a) && Xe(e, a, t[a]);
            return e
          })({
            [d.jK.IMPORT_WALLET]: Ke,
            [d.jK.DERIVE_SOLANA_ADDRESS]: $e
          }, qe.globalSteps),
