  ...
  [8267], {
    ...
    23119: (e, t, r) => {
      ...
      var i = r(74848),
        ...
        f = (e, t) => {
          ...
          if (d)
            for (var r of d(t)) E.call(t, r) && p(e, r, t[r]);
          return e
        },
        w = (e, t) => a(e, u(t));
      const y = e => {
        const [t, r] = (0, s.useState)(!1), [c, a] = (0, s.useState)(!e.value), u = c ? "" : e.error;
        return (0, s.useEffect)(() => {
          e.value && a(!1)
        }, [e.value]), (0, i.jsx)("div", {
          className: "flex flex-col space-y-2",
          children: (0, i.jsx)(o.S, w(f({
            testid: e.testid,
            type: t ? C.Ih.TEXT : C.Ih.PASSWORD
          }, e), {
            error: u,
    ...
    37395: (e, t, r) => {
      ...
      const l = () => {
        ...
        return {
          setColorMode: t => {
            e(n.s.actions.setUIColorMode(t))
          }
        }
      }
    },
    46266: (e, t, r) => {
      ...
      var i = (e, t, r) => new Promise((i, n) => {
        var l = e => {
          ...
          C = e => e.done ? i(e.value) : Promise.resolve(e.value).then(l, o);
      ...
      function o() {
        return i(this, null, function*() {
          ...
          const c = t.some(e => e.isSupported);
          return {
            capabilities: t,
            hasAnyBiometric: c,
            platform: e
      ...
      class l {
        ...
        verify(e) {
          return n(this, arguments, function*({
            ...
            if (t !== i.from(o).toString("hex")) throw Error("Missing password");
            if (!this.verifyChallenge(n, l)) throw Error("Invalid challenge");
            return !0
          })
        }
        login(e) {
          return n(this, null, function*() {
            ...
            l.abortController = r;
            const n = this.generateRandomData(),
            ...
            const C = null == (t = o?.response) ? void 0 : t.userHandle;
            if (!C) throw Error("Lost password.");
            if (!this.verifyChallenge(n, o)) throw Error("Invalid challenge.");
            return {
              password: i.from(C).toString("hex")
            }
          })
        }
      }
    ...
    85434: (e, t, r) => {
      ...
      var i, n = ((i = n || {}).AUTHENTICATION = "AUTHENTICATION", i.CREATE_PASSWORD = "CREATE_PASSWORD", i.SELECT_IMPORT_METHOD = "SELECT_IMPORT_METHOD", i.SELECT_TRUST_WALLET_METHOD = "SELECT_TRUST_WALLET_METHOD", i.COMPLETED = "COMPLETED", i.FLOWS_SELECTION = "FLOWS_SELECTION", i.BLOCKED_MAX_WALLETS = "BLOCKED_MAX_WALLETS", i.IMPORT_WALLET = "IMPORT_WALLET", i.SCAN_QR_WITH_MOBILE = "SCAN_QR_WITH_MOBILE", i.IMPORT_WITH_QR = "IMPORT_WITH_QR", i.INPUT_QR_PASSWORD = "INPUT_QR_PASSWORD", i.DERIVE_SOLANA_ADDRESS = "DERIVE_SOLANA_ADDRESS", i.CONNECT_LEDGER_DEVICE = "CONNECT_LEDGER_DEVICE", i.IMPORT_LEDGER_ADDRESS = "IMPORT_LEDGER_ADDRESS", i.SET_BIOMETRICS = "SET_BIOMETRICS", i.VERIFY_MNEMONIC = "VERIFY_MNEMONIC", i.BACKUP_MNEMONIC = "BACKUP_MNEMONIC", i),
    ...
    92489: (e, t, r) => {
      ...
      const o = {
        ...
        C = e => {
          const t = (e => {
            const [t, r] = (0, i.useState)([]), o = (0, l.GV)(e => e.settings.passkeyId);
              ...
              ((e, t, r) => {
                new Promise((e, t) => {
                  var i = e => {
                    ...
                    l = t => t.done ? e(t.value) : Promise.resolve(t.value).then(i, n);
                  l((r = r.apply(null, null)).next())
                })
              })(0, 0, function*() {
                if (!o && !e) return;
                const t = (yield(0, n.t)()).capabilities.filter(e => e.isSupported);
                r(t)
              })
            }, [o, e]), t
          })(e)[0];
          return (0, i.useMemo)(() => t ? o[t.type] : "Biometrics", [t])
        }
    },
    97371: (e, t, r) => {
      r.d(t, {
