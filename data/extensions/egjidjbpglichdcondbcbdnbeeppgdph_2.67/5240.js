try {
  let e = "u" > typeof window ? window : "u" > typeof global ? global : "u" > typeof globalThis ? globalThis : "u" > typeof self ? self : {},
    t = (new e.Error).stack;
  t && (e.t = e.t || {}, e.t[t] = "9d5f7724-c243-4500-a5f0-e3a3bc78cd1c", e.i = "sentry-dbid-9d5f7724-c243-4500-a5f0-e3a3bc78cd1c")
  ...
  [5240], {
    18109: (e, t, i) => {
      ...
      const r = class {
        ...
        wipe() {
          if (!this.wiped && this.buffer) try {
            ...
            n.A.error("Failed to wipe SecureString:", e)
          }
        }
      };
      "u" > typeof Symbol && "u" > typeof Symbol.dispose && Object.defineProperty(r.prototype, Symbol.dispose, {
        value: function() {
          this.wipe()
        },
        writable: !0,
      ...
      class o {
        constructor(e = null) {
          this.secureValue = null, this.wiped = !1, null !== e && "" !== e && (this.secureValue = new l(e))
        }
        get current() {
          return this.getValue()
        }
        set current(e) {
          null !== this.secureValue && (this.secureValue.wipe(), this.secureValue = null), null !== e && "" !== e ? (this.secureValue = new l(e), this.wiped = !1) : this.wiped = !0
        }
        wipe() {
          if (!this.wiped && null !== this.secureValue) try {
            this.secureValue.wipe(), this.secureValue = null, this.wiped = !0
          } catch (e) {
            n.A.error("Failed to wipe SecureRef:", e)
          }
        }
        getValue() {
      ...
      function c(e = null) {
        ...
        return t.current || (t.current = new o(e)), (0, s.useEffect)(() => () => {
          try {
            t.current && t.current.wipe()
          } catch (e) {
            n.A.error("Secure cleanup failed:", e)
          }
        }, []), t.current
      }
    },
    23119: (e, t, i) => {
      ...
      var n = i(74848),
        ...
        w = (e, t) => {
          for (var i in t || (t = {})) d.call(t, i) && p(e, i, t[i]);
          if (h)
            for (var i of h(t)) f.call(t, i) && p(e, i, t[i]);
          return e
        },
        E = (e, t) => u(e, C(t));
      const y = e => {
        const [t, i] = (0, c.useState)(!1), [a, u] = (0, c.useState)(!e.value), C = a ? "" : e.error;
        return (0, c.useEffect)(() => {
          e.value && u(!1)
        }, [e.value]), (0, n.jsx)("div", {
          className: "flex flex-col space-y-2",
          children: (0, n.jsx)(o.S, E(w({
            testid: e.testid,
    ...
    33263: (e, t, i) => {
      ...
      const r = ({
        ...
        children: (0, n.jsx)("path", {
          fillRule: "evenodd",
          clipRule: "evenodd",
          d: "M12.0013 4.85714C10.4234 4.85714 9.14417 6.13633 9.14417 7.71429V9.14286H14.8585V7.71429C14.8585 6.13633 13.5793 4.85714 12.0013 4.85714ZM6.28703 7.71429V9.14286H5.57279C4.38932 9.14286 3.42993 10.1022 3.42993 11.2857V19.8571C3.42993 21.0406 4.38932 22 5.57279 22H18.4299C19.6134 22 20.5728 21.0406 20.5728 19.8571V11.2857C20.5728 10.1022 19.6134 9.14286 18.4299 9.14286H17.7156V7.71429C17.7156 4.55837 15.1572 2 12.0013 2C8.8454 2 6.28703 4.55837 6.28703 7.71429ZM12.0014 17.3571C12.9876 17.3571 13.7871 16.5577 13.7871 15.5714C13.7871 14.5852 12.9876 13.7857 12.0014 13.7857C11.0151 13.7857 10.2156 14.5852 10.2156 15.5714C10.2156 16.5577 11.0151 17.3571 12.0014 17.3571Z",
          fill: "currentColor"
        })
      })
    },
    37395: (e, t, i) => {
      ...
      const l = () => {
        ...
        return {
          setColorMode: t => {
            e(r.s.actions.setUIColorMode(t))
          }
        }
      }
    },
    46266: (e, t, i) => {
      ...
      var n = (e, t, i) => new Promise((n, r) => {
        var l = e => {
          ...
          s = e => e.done ? n(e.value) : Promise.resolve(e.value).then(l, o);
        s((i = i.apply(e, t)).next())
      });

      function r() {
        const e = navigator.userAgent.toLowerCase();
        return e.includes("mac os") || e.includes("macintosh") ? "macos" : e.includes("windows") ? "windows" : e.includes("linux") ? "linux" : "unknown"
      }

      function l() {
        return n(this, null, function*() {
          if (null == PublicKeyCredential || !PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable) return !1;
          try {
      ...
      function o() {
        return n(this, null, function*() {
          const e = r(),
            t = [];
          if (!navigator.credentials || !PublicKeyCredential) return {
            capabilities: [],
            hasAnyBiometric: !1,
            platform: e
          };
          const i = yield function() {
            return n(this, null, function*() {
              return "macos" === r() && (yield l())
            })
          }();
          t.push({
            type: "touchid",
            description: {
              id: "authentication-selection.touch-id",
              defaultMessage: "Fingerprint recognition (Touch ID)"
            },
            isSupported: i,
            platform: "macos"
          });
          const o = yield function() {
            return n(this, null, function*() {
              return "windows" === r() && (yield l())
            })
          }();
          t.push({
            type: "windows-hello",
            description: {
              id: "authentication-selection.windows-hello",
              defaultMessage: "Windows Hello"
            },
            isSupported: o,
            platform: "windows"
          });
          const s = yield function() {
            return n(this, null, function*() {
              return "linux" === r() && (yield l())
            })
          }();
          t.push({
            type: "fingerprint",
            description: {
              id: "authentication-selection.fingerprint",
              defaultMessage: "Fingerprint recognition"
            },
            isSupported: s,
            platform: "linux"
          });
          ...
          t.push({
            type: "passkey",
            description: {
              id: "authentication-selection.passkey",
              defaultMessage: "Passkey"
            },
            isSupported: c,
            platform: "unknown" === e ? "unknown" : e
          });
          const a = t.some(e => e.isSupported);
          return {
            capabilities: t,
            hasAnyBiometric: a,
            platform: e
      ...
      function s(e) {
        const t = r();
        return e.find(e => e.platform === t && e.isSupported) || e.find(e => "passkey" === e.type && e.isSupported) || null
      }
    },
    70438: (e, t, i) => {
      i.d(t, {
      ...
      var n = i(48287).Buffer,
        r = (e, t, i) => new Promise((n, r) => {
          var l = e => {
              try {
                s(i.next(e))
              } catch (e) {
      ...
      class l {
        ...
        verifyChallenge(e, t) {
          return n.from(e).toString("base64").replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_") === JSON.parse((new TextDecoder).decode(t.response.clientDataJSON)).challenge
        }
        create() {
          return r(this, null, function*() {
            ...
            return {
              password: n.from(e).toString("hex"),
              credential: t,
              credentialId: n.from(t.rawId).toString("hex")
            }
          })
        }
        verify(e) {
          return r(this, arguments, function*({
            ...
            const i = e.response && e.response.getTransports && e.response.getTransports(),
              r = this.generateRandomData(),
              l = yield this.credentials.get({
                publicKey: {
                  challenge: r,
                  allowCredentials: [{
                    id: e.rawId,
              ...
              }), o = l.response.userHandle;
            if (!o) throw Error("Missing userHandle");
            if (t !== n.from(o).toString("hex")) throw Error("Missing password");
            if (!this.verifyChallenge(r, l)) throw Error("Invalid challenge");
            return !0
          })
        }
        login(e) {
          return r(this, null, function*() {
            var t;
            l.abortController && l.abortController.abort();
            const i = new AbortController;
            l.abortController = i;
            const r = this.generateRandomData(),
            ...
            if (!o) throw Error("Auth error.");
            const s = null == (t = o?.response) ? void 0 : t.userHandle;
            if (!s) throw Error("Lost password.");
            if (!this.verifyChallenge(r, o)) throw Error("Invalid challenge.");
            return {
              password: n.from(s).toString("hex")
            }
          })
        }
      }
    ...
    72960: (e, t, i) => {
      ...
      var n = i(24439);
      const r = {
        VERIFY_PASSWORD: (0, n.If)("VERIFY_PASSWORD"),
        GENERATE_PASSKEY_VAULT: (0, n.If)("GENERATE_PASSKEY_VAULT"),
        GET_PASSKEY_VAULT: (0, n.If)("GET_PASSKEY_VAULT")
      }
    },
    85434: (e, t, i) => {
      i.d(t, {
      ...
      var n, r = ((n = r || {}).AUTHENTICATION = "AUTHENTICATION", n.CREATE_PASSWORD = "CREATE_PASSWORD", n.SELECT_IMPORT_METHOD = "SELECT_IMPORT_METHOD", n.SELECT_TRUST_WALLET_METHOD = "SELECT_TRUST_WALLET_METHOD", n.COMPLETED = "COMPLETED", n.FLOWS_SELECTION = "FLOWS_SELECTION", n.BLOCKED_MAX_WALLETS = "BLOCKED_MAX_WALLETS", n.IMPORT_WALLET = "IMPORT_WALLET", n.SCAN_QR_WITH_MOBILE = "SCAN_QR_WITH_MOBILE", n.IMPORT_WITH_QR = "IMPORT_WITH_QR", n.INPUT_QR_PASSWORD = "INPUT_QR_PASSWORD", n.DERIVE_SOLANA_ADDRESS = "DERIVE_SOLANA_ADDRESS", n.CONNECT_LEDGER_DEVICE = "CONNECT_LEDGER_DEVICE", n.IMPORT_LEDGER_ADDRESS = "IMPORT_LEDGER_ADDRESS", n.SET_BIOMETRICS = "SET_BIOMETRICS", n.VERIFY_MNEMONIC = "VERIFY_MNEMONIC", n.BACKUP_MNEMONIC = "BACKUP_MNEMONIC", n),
        l = (e => (e.HOME = "HOME", e.CREATE_MNEMONIC = "CREATE_MNEMONIC", e.IMPORT_LEDGER = "IMPORT_LEDGER", e.IMPORT_WALLET = "IMPORT_WALLET", e.IMPORT_QR = "IMPORT_QR", e.BACKUP_SEEDPHRASE = "BACKUP_SEEDPHRASE", e.SET_PASSKEY = "SET_PASSKEY", e))(l || {}),
        o = (e => (e[e.HOME = 1] = "HOME", e[e.CREATE_MNEMONIC = 2] = "CREATE_MNEMONIC", e[e.IMPORT_WALLET = 3] = "IMPORT_WALLET", e[e.IMPORT_LEDGER = 3] = "IMPORT_LEDGER", e[e.IMPORT_QR = 4] = "IMPORT_QR", e[e.BACKUP_SEEDPHRASE = 2] = "BACKUP_SEEDPHRASE", e[e.SET_PASSKEY = 2] = "SET_PASSKEY", e))(o || {})
    },
    92489: (e, t, i) => {
      i.d(t, {
        m: () => s
      ...
      const o = {
        ...
        s = e => {
          const t = (e => {
            const [t, i] = (0, n.useState)([]), o = (0, l.GV)(e => e.settings.passkeyId);
              ...
              ((e, t, i) => {
                new Promise((e, t) => {
                  var n = e => {
                    ...
                    l = t => t.done ? e(t.value) : Promise.resolve(t.value).then(n, r);
                  l((i = i.apply(null, null)).next())
                })
              })(0, 0, function*() {
                if (!o && !e) return;
                const t = (yield(0, r.u)()).capabilities.filter(e => e.isSupported);
                i(t)
              })
            }, [o, e]), t
          })(e)[0];
          return (0, n.useMemo)(() => t ? o[t.type] : "Biometrics", [t])
        }
    },
    97371: (e, t, i) => {
      i.d(t, {
