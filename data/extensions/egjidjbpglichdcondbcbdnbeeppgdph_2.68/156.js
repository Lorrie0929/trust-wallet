  ...
  [156], {
    2472: (e, t, a) => {
      ...
      const r = ({
        ...
        className: `flex ${s?"flex-row":"flex-col"} gap-2`,
    ...
    18947: (e, t, a) => {
      ...
      const s = e => {
        ...
        const {
          ...
          queryFn: () => n.YW.emit(r.A.BUY_CRYPTO_WIDGET_QUOTE, e),
    ...
    30156: (e, t, a) => {
      ...
      const y = [g.J.ripple],
        v = [g.J.ripple],
        w = e => !(!e.address || (!y.includes(e.blockchainId) || void 0 !== e.isRegistered) && !1 !== e.isRegistered),
        C = ({
          coinStatus: e,
          asset: t
        }) => {
          const a = w(t),
            n = (0, u.useCallback)(e => {
              var i, n;
              return (e.metadata.enabled || void 0 === e.metadata.enabled) && e.targets.extension_enabled && (0, m.zN)((0, m.W9)(), null != (i = e.targets.extension_version_from) ? i : null, null != (n = e.targets.extension_version_to) ? n : null) && !("ripple" === t.blockchainId && t.address && "Enable this token to start using it." === e.metadata.description && !a) && !("aptos" === t.blockchainId && !a)
            }, [e, a]),
            r = e => {
              switch (e) {
                case "error":
      ...
      const E = () => (0, i.jsxs)(F.B, {
        children: [(0, i.jsx)(p.E, {
          ...
          children: [(0, i.jsx)(p.E, {
            ...
            type: f.jK.SUBTITLE,
            theme: f.Il.THIRD,
            children: ["All crypto-assets are risky, regardless of the type of token you hold. Here are some ‘baseline’ risks to be aware of before deciding to invest.", (0, i.jsx)($.c, {
      ...
      var I = a(28898),
        ...
        D = a(97286),
        W = a(89408);
      const z = ["hour", "day", "week", "month", "year", "all"];
      var U = a(15314),
        Y = a(21094),
        q = a(66118),
        X = a(44731),
      ...
      const ne = {
        ...
        se = ({
          ...
          const {
            ...
            currency: s,
            baseCurrencyType: l
          } = (0, P.P)(), [o, d] = (0, u.useState)(null), [h, m] = (0, u.useState)(r ? 5 : 1), {
            data: g,
            isLoading: y
          } = (e => {
            const {
              ...
              queryFn: () => M.YW.emit(W.A.FETCH_ASSET_CHART, e),
              refetchOnMount: !1,
            ...
            if (g?.prices && g.prices.length > 0) {
              if (null === o) return {
                price: g.prices[g.prices.length - 1].price,
                percentChange: re(g.prices[0].price, g.prices[g.prices.length - 1].price),
                change: g.prices[g.prices.length - 1].price - g.prices[0].price,
                timestamp: null
              };
              const e = new Date(0);
              return e.setUTCSeconds(g.prices[o.index].date), {
                price: g.prices[o.index].price,
                percentChange: re(g.prices[0].price, g.prices[o.index].price),
                change: g.prices[o.index].price - g.prices[0].price,
                timestamp: e
              }
            }
            return {
          ...
          }, [g?.prices, o]), b = (0, u.useMemo)(() => {
            if (!g?.prices) return null;
            const e = g.prices.map(e => e.price);
            return {
              labels: e,
              datasets: [{
                data: e,
                backgroundColor: n === U.W.LIGHT ? "white" : "black",
                borderColor: 0 > (C ?? 0) ? "#E33B54" : "#03A66D",
                borderWidth: 2,
                borderJoinStyle: "round",
                pointStyle: !1
              }]
            }
          }, [g?.prices, C]), N = (0, u.useMemo)(() => ({
            hour: a({
            ...
            afterDraw: e => {
              if (e.getActiveElements().length) {
                ...
                const n = e.chartArea,
                  r = e.ctx;
                return r.save(), r.beginPath(), r.moveTo(i.element.x, n.top), r.lineTo(i.element.x, n.bottom), r.lineWidth = 1, r.setLineDash([3, 3]), r.strokeStyle = t, r.stroke(), r.restore(), r.beginPath(), r.arc(i.element.x, i.element.y, 5, 0, 2 * Math.PI), r.fillStyle = t, r.fill(), r.lineWidth = 2, r.strokeStyle = a, r.stroke(), void r.restore()
              }
              d(null)
            }
          }], []);
          return (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)("div", {
              ...
              children: [(0, i.jsx)(B.E, {
                isLoading: y,
                className: "w-24",
                children: (0, i.jsx)(Z.h, {
                  testid: "asset-fiat-price",
                  textType: f.jK.HEADER_32,
                  amountType: l,
                  value: v ?? 0,
                  currency: s,
                ...
                children: (0, i.jsxs)("div", {
                  ...
                  children: [(0, i.jsxs)("div", {
                    ...
                    children: [(0, i.jsx)(R.b, {
                      width: 16,
                      height: 16,
                      colorClass: 0 > (w ?? 0) ? "text-error-1-default" : "text-success-1-default rotate-180"
                    }), (0, i.jsx)(Z.h, {
                      testid: "asset-fiat-amount-change",
                      textType: f.jK.SUBHEADER_16,
                      amountType: l,
                      currency: s,
                      theme: 0 > (w ?? 0) ? f.Il.ERROR : f.Il.SUCCESS,
                      value: w ?? 0
                    }), (0, i.jsx)(Z.h, {
                      ...
                      prefix: "(",
                      suffix: ")",
                      amountType: Y.Cu.PERCENT,
                      theme: 0 > (C ?? 0) ? f.Il.ERROR : f.Il.SUCCESS,
                      value: C ?? 0
                    })]
                  }), (0, i.jsx)("div", {
                    className: "h-4",
      ...
      var ce = Object.defineProperty,
        ...
        ge = (e, t) => {
          ...
          if (ue)
            for (var a of ue(t)) fe.call(t, a) && pe(e, a, t[a]);
          return e
        },
        ye = (e, t) => de(e, he(t));
      const ve = ({
          ...
          ((e, t, a) => {
            new Promise((e, t) => {
              var i = e => {
                ...
                r = t => t.done ? e(t.value) : Promise.resolve(t.value).then(i, n);
              r((a = a.apply(null, null)).next())
            })
          })(0, 0, function*() {
            const [t] = yield Promise.all([M.YW.emit(S.A.FETCH_BALANCE, {
              blockchainId: e.blockchainId,
              decimals: e.decimals,
              address: e.address
            }), M.YW.emit(S.A.FETCH_STAKING_LIST)]);
            V.M_.dispatch(A.u.actions.setBalances({
              walletId: a,
              balances: [ye(ge({}, t), {
                assetId: e.assetId
              })],
        ...
        const {
          ...
          const [t, a] = (0, u.useState)(""), [i, n] = (0, u.useState)(""), [r, s] = (0, u.useState)("text-iconNormal"), l = (0, V.GV)(e => e.sdkFeatures.gasStatus), {
            currency: o
          } = (0, P.P)();
          return (0, u.useEffect)(() => {
            e && M.YW.emit(H.A.GAS_STATUS, {
              action: T.Y.INITIATE,
              params: {
                assetId: e,
                currency: o
      ...
      var we = a(62266),
        ...
        Oe = a(3280),
        _e = a(96471);
      const Fe = e => e.blockchainId === g.J.ripple && e.address ? {
        coinActivationFee: "1",
      ...
      const je = ({
        ...
        })(e.blockchainId), c = (0, Be.Hy)(t, e), d = l?.coinActivationFee, h = l?.tokenActivationFee;
        return l ? (0, i.jsx)(Ie.a, {
          opened: a,
          onClose: n,
          children: (0, i.jsxs)("div", {
      ...
      var Ue = a(65828),
        ...
        Ke = (e, t, a) => new Promise((i, n) => {
          var r = e => {
            ...
            l = e => e.done ? i(e.value) : Promise.resolve(e.value).then(r, s);
      ...
      const Qe = ({
        ...
        const n = (0, N.Zp)(),
          ...
          p = Fe(e),
          [g, y] = (0, u.useState)(!1),
          w = e.isBuyCryptoEnabled && !h,
          C = e.isSellCryptoEnabled && !h,
          x = (0, qe.w)(e.assetId),
          b = (0, Xe.G)(e),
          k = !w || !C,
          M = e.type === _e.S.BRC20,
          H = () => {
            const t = v.includes(e.blockchainId) ? Ze.wL.TrustLine : Ze.wL.RegisterToken;
            n("" + s.b.SEND_CONFIRM, {
              state: {
                asset: e,
                network: a,
        ...
        return (0, i.jsx)(i.Fragment, {
          children: (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)("div", {
              className: "w-full flex items-center " + (k ? "justify-center space-x-6" : "justify-between px-5"),
              children: [(0, i.jsx)(De.a, {
                ...
                disabled: t,
                onClick: () => {
                  n(`${s.b.SEND}/${e.assetId}${M?"/inscriptions":""}`)
                }
              }), (0, i.jsx)(De.a, {
                ...
                onClick: () => {
                  c(`${s.b.ASSET}/${e.assetId}`), n(`${s.b.RECEIVE}/${e.assetId}`)
                },
                disabled: t
              }), t && (0, i.jsx)(De.a, {
                ...
                icon: (0, i.jsx)(Se.f, {
                  colorClass: T ? "text-utility-1-opacity-1" : "text-textOnPrimary"
                }),
                disabled: t || d,
                theme: T ? Ye.ry.SECONDARY : Ye.ry.BRAND,
                onClick: () => {
                  n(b, {
                    state: {
                      pageViewSource: r.Un.ASSET
                    }
                  })
                }
              }), w && (0, i.jsx)(De.a, {
                ...
                icon: (0, i.jsx)(ze, {
                  colorClass: T ? "text-textOnPrimary" : "text-utility-1-opacity-1"
                }),
                disabled: t,
                theme: T ? Ye.ry.BRAND : Ye.ry.SECONDARY,
                onClick: () => Ke(null, null, function*() {
                  yield o(`${s.b.BUY}/${e.assetId}`)
                })
              }), C && (0, i.jsx)(De.a, {
      ...
      const rt = ({
          ...
          const {
            formatMessage: t
          } = (0, K.A)(), [a, n] = (0, u.useState)(!1), r = (0, at.A)(e.assetId), s = function(e) {
            var t;
            return (null == (t = (0, it.t)()[e]) ? void 0 : t.inscription) || "0"
          }(e.assetId), l = (0, nt.P)(e.assetId), o = [{
            type: "balance",
            label: e.type !== _e.S.BRC20 ? "inscription-overview.available-balance" : "inscription-overview.non-transferable-balance",
            value: r,
            display: !0
          }, {
            type: "transferable",
          ...
          return (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)("div", {
              ...
              children: o.map(({
                ...
                hideLine: !0,
                variant: tt.P.TABLE_LIST_TALL,
                labelInfoAction: l,
                children: (0, i.jsx)(Z.h, {
                  currency: e.symbol,
                  amountType: Y.Cu.CRYPTO,
                  value: r
                })
              }, a) : null)
            }), (0, i.jsx)(Je, {
        ...
        st = ["balance", "staked", "rewards", "pending", "frozen", "locked", "blocked", "claimable", "transferable", "inscription", "dust", "reserved"],
        lt = ({
          asset: e
        }) => {
          const {
            formatMessage: t
          } = (0, K.A)(), a = (0, it.t)(), n = (0, u.useMemo)(() => {
            const t = {};
            return st.forEach(i => {
              var n, r;
              t[i] = null != (r = null == (n = a[e.assetId]) ? void 0 : n[i]) ? r : "0"
            }), t
          }, [a[e.assetId]]);
          return (0, i.jsx)("div", {
            className: "w-full",
            children: ["balance", "staked", "pending", "locked", "blocked", "frozen", "reserved"].map(a => "0" !== n[a] ? (0, i.jsx)(et.F, {
              label: t({
      ...
      var ot, ct = a(13772),
        dt = ((ot = dt || {}).DEFAULT = "DEFAULT", ot.BRAND = "BRAND", ot.ACCENT_PINK = "ACCENT_PINK", ot.ACCENT_NEON_GREEN = "ACCENT_NEON_GREEN", ot.ACCENT_YELLOW = "ACCENT_YELLOW", ot.ACCENT_BLUE = "ACCENT_BLUE", ot),
        ht = (e => (e.MEDIUM = "MEDIUM", e.MINIMAL = "MINIMAL", e))(ht || {});
      const ut = {
          [dt.DEFAULT]: "border-utility-1-opacity-5",
          [dt.BRAND]: "border-primary-default",
          [dt.ACCENT_PINK]: "border-accent-pink",
          [dt.ACCENT_NEON_GREEN]: "border-accent-neon-green",
          [dt.ACCENT_YELLOW]: "border-accent-yellow",
          [dt.ACCENT_BLUE]: "border-accent-blue"
        },
        mt = {
          [dt.DEFAULT]: "text-primary-default",
          [dt.BRAND]: "text-primary-default",
          [dt.ACCENT_PINK]: "text-accent-pink",
          [dt.ACCENT_NEON_GREEN]: "text-accent-neon-green",
          [dt.ACCENT_YELLOW]: "text-accent-yellow",
          [dt.ACCENT_BLUE]: "text-accent-blue"
        },
        ft = {
          [dt.DEFAULT]: "bg-utility-1-opacity-5",
          [dt.BRAND]: "bg-primary-default",
          [dt.ACCENT_PINK]: "bg-accent-pink",
          [dt.ACCENT_NEON_GREEN]: "bg-accent-neon-green",
          [dt.ACCENT_YELLOW]: "bg-accent-yellow",
          [dt.ACCENT_BLUE]: "bg-accent-blue"
        },
        pt = {
          [ht.MEDIUM]: "px-4 py-3",
          [ht.MINIMAL]: "p-0"
        ...
        yt = ({
          ...
          className: ut[t] + " relative overflow-hidden bg-background-2 border rounded-4 w-full",
          children: [(0, i.jsx)(gt, {
            className: mt[t] + " absolute pointer-events-none"
          }), a && (0, i.jsx)("div", {
            className: ft[t] + " absolute pointer-events-none w-8 h-6 rounded-br-4 py-1 px-2 text-on-primary",
            children: a
          }), (0, i.jsx)("div", {
            className: "" + pt[e],
            children: n
      ...
      function Ct(e) {
        var t;
        return (null == (t = (0, it.t)()[e]) ? void 0 : t.pending) || "0"
      }

      function xt(e) {
        var t;
        return (null == (t = (0, it.t)()[e]) ? void 0 : t.rewards) || "0"
      }
      var bt = a(11549);
      const Nt = ({
        assetId: e,
        ...
        const {
          formatMessage: n
        } = (0, K.A)(), r = (0, Ae.s)(), l = (0, V.GV)(e => e.staking.stakingList), o = function(e) {
          var t;
          const a = (0, it.t)()[e];
          return new wt.A(null != (t = a?.staked) ? t : "0").toString()
        }(e), c = Ct(e), d = xt(e), h = function(e) {
          var t, a;
          return null != (a = null == (t = (0, it.t)()[e]) ? void 0 : t.frozen) ? a : "0"
        }(e), m = function(e) {
          var t;
          return (null == (t = (0, it.t)()[e]) ? void 0 : t.claimable) || "0"
        }(e), g = (0, bt.Y9)(t).toLowerCase(), y = "0" === o && "0" === c && "0" === d && "0" === h && "0" === m, v = () => ((e, t, a) => new Promise((e, t) => {
          var i = e => {
              try {
                r(a.next(e))
              } catch (e) {
          ...
          yield M.YW.emit(H.A.EARN, {
            action: ct.v.SET_CURRENT_WALLET
          }), yield r(`${s.b.EARN_STAKING}${e}`, {
            state: {
              navigationParams: {
            ...
            children: (0, i.jsxs)("div", {
              ...
              children: [(0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(p.E, {
                  ...
                  children: n({
                    id: `staking-teaser.${g}-staking`
                  })
                }), (0, i.jsx)(Z.h, {
                  amountType: Y.Cu.CRYPTO,
                  value: o,
                  currency: a,
                  textType: f.jK.SUBHEADER_18
                }), (0, i.jsx)(p.E, {
                  type: f.jK.CAPTION_12,
                  theme: f.Il.PRIMARY_DEFAULT,
                  children: "0" === d ? n({
      ...
      const Mt = e => {
        const {
          ...
          strokeWidth: r = 8,
          className: s
        } = e, l = (n - r) / 2, o = `0 0 ${n} ${n}`, c = l * Math.PI * 2, d = c - c * (a || 0) / 100;
        return (0, i.jsxs)("svg", {
          width: n,
          height: n,
          viewBox: o,
      ...
      const St = ({
        ...
        return (0, i.jsx)(Ie.a, {
          opened: e,
          onClose: t,
          placement: Pt.Gn.CENTER,
          children: (0, i.jsxs)(Lt.o, {
            direction: Vt.R.COLUMN,
            children: [(0, i.jsx)("div", {
              children: (0, i.jsx)($e.I, {})
            }), (0, i.jsxs)("div", {
      ...
      const Ot = ({
          ...
          const {
            formatMessage: t
          } = (0, K.A)(), [a, n] = (0, u.useState)(!1), [r, s] = (0, u.useState)(0), [l, o] = (0, u.useState)(0), [c, d] = (0, u.useState)(0), [h, m] = (0, u.useState)(0), g = function(e) {
            var t, a, i, n, r, s, l, o;
            const c = (0, it.t)();
            return {
              energy: {
              ...
              bandwidth: {
                amount: (null == (s = null == (r = c[e]) ? void 0 : r.bandwidth) ? void 0 : s.amount) || "0",
          ...
          return (0, u.useEffect)(() => {
            var e, t, a, i;
            const n = null != (e = +g.bandwidth.limit) ? e : 0,
              c = null != (t = +g.energy.limit) ? t : 0;
            o(null != (a = +g.bandwidth.amount) ? a : 0), s(null != (i = +g.energy.amount) ? i : 0), d(r / c * 100), m(l / n * 100)
          }, [e, g]), (0, i.jsxs)("div", {
            className: "flex items-center justify-between space-x-4",
            children: [(0, i.jsx)(kt.Z, {
              children: (0, i.jsxs)("div", {
        ...
        _t = ["c20000714_t0x4B0F1812e5Df2A09796481Ff14017e6005508003", "c20000714_t0xB0b84D294e0C75A6abe60171b70edEb2EFd14A1B"];
      var Ft = a(33653),
        $t = a(29251),
        Et = a(65504),
        It = a(4504);
      ...
      const Wt = ({
        ...
        const {
          formatMessage: r
        } = (0, K.A)(), s = (0, O.A)(), l = function(e) {
          var t, a;
          const i = (0, it.t)();
          return new wt.A(null != (a = null == (t = i[e]) ? void 0 : t.staked) ? a : "0").toString()
        }(e.assetId), o = xt(e.assetId), c = Ct(e.assetId), d = function(e) {
          var t;
          return (null == (t = (0, it.t)()[e]) ? void 0 : t.reserved) || "0"
        }(e.assetId), h = Rt(e.assetId), m = function(e) {
          var t, a;
          const i = Rt(null != (t = e?.assetId) ? t : ""),
            n = (0, Bt.q)(e);
          return new wt.A(i).mul(null != (a = n?.price) ? a : "0").toString()
        }(e), {
          currency: y,
          baseCurrencyType: w
        } = (0, P.P)(), C = (0, Bt.q)(e), [x, b] = (0, u.useState)(!1), N = e.type === _e.S.BRC20, k = Ft.bm.includes(e.blockchainId) && !e.address && s.type !== $t.S.HARDWARE, M = _t.includes(e.assetId), H = v.includes(e.blockchainId) && !e.address, T = k && new wt.A(l).add(o).add(c).gt(0) || M || t.id === g.J.tron || H && new wt.A(d).gt(0), L = N || e.blockchainId === g.J.bitcoin, V = t.id === g.J.tron;
        return (0, i.jsxs)("div", {
          className: "flex flex-col gap-2 w-full",
          children: [(0, i.jsx)(p.E, {
            type: f.jK.SUBHEADER_16,
            lineHeight: f.jK.SUBHEADER_20,
            children: r({
            ...
            children: (0, i.jsxs)("div", {
              ...
              children: [(0, i.jsx)(Et.q, {
                ...
                children: [(0, i.jsxs)("div", {
                  ...
                  children: [(0, i.jsx)(p.E, {
                    type: f.jK.HEADER_16,
                    lineHeight: f.jK.HEADER_20,
                    children: e.name
                  }), (0, i.jsx)(Z.h, {
                    value: h,
                    currency: e.symbol,
                    amountType: Y.Cu.CRYPTO,
                    textType: f.jK.BODY_14,
                    lineHeight: f.jK.BODY_16
                  })]
                }), (0, i.jsxs)("div", {
                  ...
                  children: [(0, i.jsx)(Z.h, {
                    ...
                    heightClass: "h-4",
                    children: (0, i.jsx)(Z.h, {
                      value: null != (a = C?.change_24h) ? a : 0,
                      amountType: Y.Cu.PERCENT,
                      textType: f.jK.BODY_14,
                      lineHeight: f.jK.BODY_16,
                      theme: 0 > (null != (n = C?.change_24h) ? n : 0) ? f.Il.ERROR_1_DEFAULT : f.Il.SUCCESS_1_DEFAULT
                    })
                  })]
                })]
              })]
      ...
      const Ut = ({
        ...
        Xt = ({
          ...
          const {
            ...
            warning: f.Il.WARNING,
            risk: f.Il.ERROR,
            success: f.Il.SUCCESS
          }, d = {
            warning: "warning-alert",
            risk: "error-alert",
            success: "p-3"
          }, h = "number" == typeof e?.buy_tax, m = (0, u.useMemo)(() => n ? e?.num_risks > 0 ? r({
          ...
          }), [n, e]), g = (0, u.useMemo)(() => !n || e?.num_risks > 0 ? "risk" : e?.num_warnings > 0 ? "warning" : "success", [n, e]);
          return (0, i.jsxs)(kt.Z, {
            noPadding: !0,
            children: [(0, i.jsxs)("div", {
              ...
              children: [(0, i.jsxs)("div", {
                ...
                width: 16,
                height: 16,
                colorClass: "transition-transform mr-2 " + (s ? "rotate-180" : "rotate-0")
              })]
            }), n && s && (0, i.jsxs)("div", {
              ...
              children: [h && (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsxs)("div", {
                  ...
                  children: [o[e.type], (0, i.jsx)(p.E, {
                    type: f.jK.BODY_12,
                    theme: c[e.type],
                    children: (0, zt.capitalize)(e.type)
                  })]
                }, e.code), (0, i.jsx)(p.E, {
                  type: f.jK.BODY_12,
                  theme: c[e.type],
      ...
      const Jt = ({
        ...
        return (0, i.jsx)(Qt.v, {
          theme: e ? Gt.x.SUCCESS : Gt.x.ERROR,
          size: Gt.V.TINY,
          children: (0, i.jsx)(p.E, {
            type: f.jK.CAPTION_10,
            weight: f.nG.MEDIUM,
            theme: e ? f.Il.SUCCESS : f.Il.ERROR,
            children: t({
      ...
      const ta = ({
        ...
        const {
          ...
          const {
            ...
            queryFn: () => M.YW.emit(W.A.FETCH_MARKET_INFO, e),
            staleTime: 36e5,
            refetchOnWindowFocus: !1
          });
          return [t, a]
        })(e.assetId), [C, x] = (0, u.useState)(!1), b = (0, u.useMemo)(() => {
          const e = [...w?.info.links || []];
          return w?.info.research && e.unshift({
            name: "Research",
            url: w?.info.research
          }), w?.info.explorer && e.unshift({
            name: "Explorer",
            url: w?.info.explorer
          }), w?.info.website && e.unshift({
            name: "Official website",
            url: w?.info.website
          }), e
        }, [null == (n = w?.info.links) ? void 0 : n.length]);
        return (0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(B.E, {
            ...
            children: w?.info.description && (0, i.jsx)(p.E, {
              type: f.jK.BODY_14,
              lineHeight: f.jK.BODY_16,
              children: (0, zt.truncate)(w.info.description, {
                length: C ? null != (s = null == (r = w.info.description) ? void 0 : r.length) ? s : 0 : 220
              })
            })
          }), (null != (o = null == (l = w?.info.description) ? void 0 : l.length) ? o : 0) > 220 && (0, i.jsx)(Ee.$, {
            onClick: () => x(!C),
            size: Ye.Vp.SMALL,
            theme: Ye.ry.BRAND_TRANSPARENT,
            noPadding: !0,
            fullWidth: !1,
            className: "py-2",
            children: y({
              id: "generic.view-" + (C ? "less" : "more")
            })
            ...
            children: (0, i.jsxs)("div", {
              ...
              children: [(0, i.jsx)(et.F, {
                ...
                children: (0, i.jsx)(B.E, {
                  ...
                  className: "w-20 h-3",
                  children: (0, i.jsx)(Z.h, {
                    textType: f.jK.SUBHEADER_14,
                    theme: f.Il.UTILITY_1_OPACITY_1,
                    lineHeight: f.jK.SUBHEADER_18,
                    amountType: Y.Cu.FIAT,
                    currency: "USD",
                    value: null != (c = w?.marketCap) ? c : 0
                  })
                })
              }), (0, i.jsx)(et.F, {
                variant: tt.P.TABLE_LIST_TALL,
                ...
                children: (0, i.jsx)(B.E, {
                  ...
                  children: (0, i.jsx)(Z.h, {
                    ...
                    currency: e.symbol,
                    value: null != (d = w?.circulatingSupply) ? d : 0
                  })
                })
              }), (0, i.jsx)(et.F, {
                variant: tt.P.TABLE_LIST_TALL,
                ...
                children: (0, i.jsx)(B.E, {
                  ...
                  children: (0, i.jsx)(Z.h, {
                    ...
                    currency: e.symbol,
                    amountType: Y.Cu.CRYPTO,
                    value: null != (h = w?.totalSupply) ? h : 0
                  })
                })
              }), (0, i.jsx)(et.F, {
                variant: tt.P.TABLE_LIST_TALL,
              ...
              children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsxs)("div", {
                  ...
                  children: [(0, i.jsx)(Et.q, {
                    ...
                    type: f.jK.SUBHEADER_14,
                    lineHeight: f.jK.SUBHEADER_18,
                    children: null != (g = t.displayName) ? g : t.name
                  })]
                }), (0, i.jsx)("a", {
            ...
            children: (0, i.jsx)("div", {
              ...
              children: b?.map((e, t) => (0, i.jsx)("a", {
                ...
                children: (0, i.jsx)(Ee.$, {
                  ...
                  fullWidth: !1,
                  children: (0, zt.capitalize)(e.name)
                }, "asset-about-link-" + t)
              }))
            })
          })]
      ...
      const ha = ({
        ...
        const {
          ...
          trackAnalytics: a
        } = (0, sa.s)(), [n, s] = (0, u.useState)(""), [l, o] = (0, u.useState)(), [c, d] = (0, u.useState)(), [h, m] = (0, u.useState)(), [g, y] = (0, u.useState)(), [v, w] = (0, u.useState)(!1), C = (0, O.A)(), x = (0, ke.F7)(e.assetId), b = (0, u.useRef)(0), N = (0, u.useRef)(null), k = (0, u.useMemo)(() => {
          if (!C || !x?.address) return null;
        ...
        }, [C, x?.address, e.assetId, n]), {
          data: H,
          isLoading: T,
          refetch: L
        } = (0, ca.A)(k), V = H?.currencyConfig, P = H?.quote;
        (0, u.useEffect)(() => {
          V?.defaultAmount && 0 === b.current && (s(V.defaultAmount.toString()), d(V.fiatCurrency), m(V.defaultAmount), y(V.suggestedAmounts), b.current++)
        }, [V?.defaultAmount]), (0, u.useEffect)(() => () => {
          N.current && clearTimeout(N.current)
        }, []);
        const S = e => {
            s(e), N.current && (clearTimeout(N.current), N.current = null);
            const {
              isValid: a,
              error: i
            } = (e => {
            ...
            o(i), a && (N.current = setTimeout(() => da(null, null, function*() {
              b.current++, yield L()
            }), 300))
          },
          A = () => da(null, null, function*() {
            var t;
            if (P) {
              w(!0);
              try {
                const {
                  ...
                  address: s,
                  error: l
                } = yield M.YW.emit(na.A.BUY_CRYPTO, {
                  quote: {
                    id: P.id,
                ...
                if (l?.message) return void ra.Ay.error(l.message);
                const o = new URL(i);
                n && o.searchParams.set(n, s);
                for (const [e, t] of o.searchParams) "address" === e && o.searchParams.set(e, (0, la.d)(t));
                window.open(o, "_blank"), a({
                  event: r.Un.FIAT_ON_RAMPS_PROVIDER,
                  props: {
                    pageViewResourceType: r.Rb.EXTERNAL,
                    blockchainId: e.blockchainId,
              ...
              children: [(0, i.jsxs)("div", {
                ...
                children: [(0, i.jsxs)("div", {
                  ...
                  children: [(0, i.jsx)(jt.S, {
                    ...
                    widthClass: "w-[100px]",
                    heightClass: "h-8",
                    children: (0, i.jsx)(aa.R, {
                      placeholder: "0",
                      value: n,
                      disabled: v || !b.current,
                      align: ia.Bi.LEFT,
                      amountType: ia.yf.FIAT,
                      onChange: S,
                      currency: c,
                ...
                children: [(0, i.jsx)(oa.i, {
                  length: 4,
                  widthClass: "w-8",
                  heightClass: "h-6",
                  isLoading: !g,
                  horizontal: !0
                }), g?.map((e, t) => (0, i.jsx)(Ee.$, {
                  size: Ye.Vp.XSMALL,
                  onClick: () => (e => {
                    S(e.toString()), P && !v && A()
                  })(e),
      ...
      const va = () => {
        ...
        const g = (0, be.Mr)(a);
        if (!g) throw Error(`Could not find asset for assetId "${a}"`);
        const [y, v] = (0, ya.N)(g.assetId), C = (0, c.V)(g.assetId), x = (0, Ne.A)(g), b = (0, ke.F7)(x.coinId), k = w(g);
        if (!x) throw Error(`Could not find blockchain with id ID "${g.blockchainId}".`);
        (0, u.useEffect)(() => {
          M.YW.emit(W.A.FETCH_MARKET_SENTIMENT_ASSETS)
        }, []), (0, l.K)({
          event: r.Un.ASSET,
          props: {
            assetId: g.assetId,
            assetName: g.name,
            blockchainId: g.blockchainId
          }
        });
        const H = (0, N.Zp)(),
          T = (0, Ce.q)(x, g),
          ...
          [V, P] = (0, u.useState)(null != (e = h?.activeTab) ? e : Ge.k$.HOLDINGS),
          S = (0, u.useMemo)(() => window.innerHeight - xe.a4 - (C ? 72 : 0) - (d ? 0 : xe.e4 + xe.Et) - 96, [d]),
          {
            isFetching: A,
            transactionsFetched: O,
            hasNextPage: _,
            lastFetchedTransactionTime: F,
            emptyPeriodFetched: $,
            fetchNextPage: E
          } = (0, we.Tl)(g, x, b.address),
          I = (0, u.useMemo)(() => !(Object.keys(T).length || !O) || A, [T, O]);
        return (0, i.jsxs)(xe.LN, {
          children: [(0, i.jsx)(xe.zY, {
            title: g.symbol,
            subtitle: null != (t = x.displayName) ? t : x.name,
            backAction: () => {
              H(h?.origin ? h.origin : s.b.DEFAULT)
            }
          }), (0, i.jsxs)(xe.Gv, {
            children: [C && (0, i.jsx)("div", {
              ...
              children: [(0, i.jsx)(ve, {
                asset: g,
                coinStatus: v
              }), v?.isBuyCryptoEnabled && (0, i.jsx)(ha, {
                asset: g
              }), (0, i.jsxs)(j.fu, {
                as: u.Fragment,
                selectedIndex: V,
                    ...
                    children: L.map(e => (0, i.jsx)(j.oz, {
                      ...
                      children: ({
                        ...
                        children: [(0, i.jsx)("div", {
                          ...
                          children: (0, i.jsx)(p.E, {
                            theme: t ? f.Il.UTILITY_1_DEFAULT : f.Il.UTILITY_1_OPACITY_2,
                            type: f.jK.SUBHEADER_16,
                            weight: f.nG.MEDIUM,
                            children: e.title
                          })
      ...
      function d(e) {
        var t = function(t) {
          var a = (0, o.A)(),
            i = t.value,
            n = t.children,
            r = (0, s.Tt)(t, ["value", "children"]),
            l = "string" == typeof i ? new Date(i || 0) : i;
          return n("formatDate" === e ? a.formatDateToParts(l, r) : a.formatTimeToParts(l, r))
        };
    ...
    85266: (e, t, a) => {
      ...
      const s = () => {
        ...
        return {
          ...
          setNavigationOrigin: (0, i.useCallback)(t => {
            e(r.A.actions.setNavigationOrigin(t))
          }, [e]),
          clearNavigationOrigin: (0, i.useCallback)(() => {
            e(r.A.actions.clearNavigationOrigin())
          }, [e])
        }
      }
    }
